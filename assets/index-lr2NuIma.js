...
`].filter(Wl).join(`
`)),p=jp(p),p=g_(p,i),p=__(p,i),m=jp(m),m=g_(m,i),m=__(m,i),p=v_(p),m=v_(m),i.isRawShaderMaterial!==!0&&(W=`#version 300 es
...
`)}return d=d.replace(/\s+$/,""),d}function fc(c,d,g){var S=uc(c);if(!d||g<=0)return Z(S)+1;var C=Ln(S,d,g);return C+1}var rr=()=>2147483648,Qr=()=>rr(),Rf=c=>{var d=P.buffer,g=(c-d.byteLength+65535)/65536|0;try{return P.grow(g),Te(),1}catch{}},Is=c=>{var d=oe.length;c>>>=0;var g=rr();if(c>g)return!1;for(var S=1;S<=4;S*=2){var C=d*(1+.2/S);C=Math.min(C,c+100663296);var z=Math.min(g,at(Math.max(c,C),65536)),k=Rf(z);if(k)return!0}return!1},Hs={},hc=()=>D||"./this.program",Ea=()=>{if(!Ea.strings){var c=(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",d={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:c,_:hc()};for(var g in Hs)Hs[g]===void 0?delete d[g]:d[g]=Hs[g];var S=[];for(var g in d)S.push(`${g}=${d[g]}`);Ea.strings=S}return Ea.strings},el=(c,d)=>{for(var g=0;g<c.length;++g)re[d++]=c.charCodeAt(g);re[d]=0},dc=(c,d)=>{var g=0;return Ea().forEach((S,C)=>{var z=d+g;X[c+C*4>>2]=z,el(S,z),g+=S.length+1}),0},pc=(c,d)=>{var g=Ea();X[c>>2]=g.length;var S=0;return g.forEach(C=>S+=C.length+1),X[d>>2]=S,0},mc=c=>{N(c,new je(c))},Cf=(c,d)=>{mc(c)},Df=Cf;function Uf(c){try{var d=Gt.getStreamFromFD(c);return w.close(d),0}catch(g){if(typeof w>"u"||g.name!=="ErrnoError")throw g;return g.errno}}var Lf=(c,d,g,S)=>{for(var C=0,z=0;z<g;z++){var k=X[d>>2],K=X[d+4>>2];d+=8;var ge=w.read(c,re,k,K,S);if(ge<0)return-1;if(C+=ge,ge<K)break}return C};function Nf(c,d,g,S){try{var C=Gt.getStreamFromFD(c),z=Lf(C,d,g);return X[S>>2]=z,0}catch(k){if(typeof w>"u"||k.name!=="ErrnoError")throw k;return k.errno}}function fi(c,d,g,S,C){var z=zs(d,g);try{if(isNaN(z))return 61;var k=Gt.getStreamFromFD(c);return w.llseek(k,z,S),Ye=[k.position>>>0,(ie=k.position,+Math.abs(ie)>=1?ie>0?+Math.floor(ie/4294967296)>>>0:~~+Math.ceil((ie-+(~~ie>>>0))/4294967296)>>>0:0)],B[C>>2]=Ye[0],B[C+4>>2]=Ye[1],k.getdents&&z===0&&S===0&&(k.getdents=null),0}catch(K){if(typeof w>"u"||K.name!=="ErrnoError")throw K;return K.errno}}var Jr=(c,d,g,S)=>{for(var C=0,z=0;z<g;z++){var k=X[d>>2],K=X[d+4>>2];d+=8;var ge=w.write(c,re,k,K,S);if(ge<0)return-1;if(C+=ge,ge<K)break}return C};function xc(c,d,g,S){try{var C=Gt.getStreamFromFD(c),z=Jr(C,d,g);return X[S>>2]=z,0}catch(k){if(typeof w>"u"||k.name!=="ErrnoError")throw k;return k.errno}}w.createPreloadedFile=Gr,w.staticInit(),ae(),bt=p.BindingError=class extends Error{constructor(d){super(d),this.name="BindingError"}},Dt=p.InternalError=class extends Error{constructor(d){super(d),this.name="InternalError"}},ji(),ir=p.UnboundTypeError=jo(Error,"UnboundTypeError");var gc={M:ui,N:En,h:tr,I:Vo,Q:Go,F:As,G:ba,j:Xr,B:la,H:L,C:te,A:xe,w:ce,V:sn,U:Pn,n:Pi,f:ec,b:Ls,a:tc,m:Ma,i:nc,W:sf,J:lf,x:uf,L:ff,e:hf,q:pf,T:Oi,u:mf,p:gf,k:_f,Y:vf,X:yf,r:Sf,Z:bf,o:Mf,c:Ef,d:$o,t:lc,s:cc,O:ar,K:Af,R:fc,z:Qr,y:Is,D:dc,E:pc,S:Df,g:Uf,P:Nf,v:fi,l:xc},Fn=Re(),tl=c=>(tl=Fn.aa)(c),$r=c=>($r=Fn.ca)(c),$i=c=>($i=Fn.da)(c),Ta=c=>(Ta=Fn.ea)(c),Vs=(c,d)=>(Vs=Fn.fa)(c,d),sr=()=>(sr=Fn.ga)();p.dynCall_viijii=(c,d,g,S,C,z,k)=>(p.dynCall_viijii=Fn.ha)(c,d,g,S,C,z,k),p.dynCall_viiiiji=(c,d,g,S,C,z,k,K)=>(p.dynCall_viiiiji=Fn.ia)(c,d,g,S,C,z,k,K),p.dynCall_jiji=(c,d,g,S,C)=>(p.dynCall_jiji=Fn.ja)(c,d,g,S,C),p.dynCall_iiiiij=(c,d,g,S,C,z,k)=>(p.dynCall_iiiiij=Fn.ka)(c,d,g,S,C,z,k),p.dynCall_iiiiijj=(c,d,g,S,C,z,k,K,ge)=>(p.dynCall_iiiiijj=Fn.la)(c,d,g,S,C,z,k,K,ge),p.dynCall_iiiiiijj=(c,d,g,S,C,z,k,K,ge,Oe)=>(p.dynCall_iiiiiijj=Fn.ma)(c,d,g,S,C,z,k,K,ge,Oe);var or,nl;rn=function c(){or||ua(),or||(rn=c)};function ua(){if(Et>0||!nl&&(nl=1,et(),Et>0))return;function c(){or||(or=1,p.calledRun=1,!O&&(he(),m(p),p.onRuntimeInitialized?.(),ve()))}p.setStatus?(p.setStatus("Running..."),setTimeout(()=>{setTimeout(()=>p.setStatus(""),1),c()},1)):c()}if(p.preInit)for(typeof p.preInit=="function"&&(p.preInit=[p.preInit]);p.preInit.length>0;)p.preInit.pop()();return ua(),f=x,f})})();o.exports=i})(np)),np.exports}var xT=mT();const gT=My(xT),_T="/step-3d-viewer/assets/occt-import-js-BhHfLpto.wasm";let ap=null;const vT={linearUnit:"millimeter",linearDeflectionType:"bounding_box_ratio",linearDeflection:.003,angularDeflection:.4};function w_(){return ap||(ap=gT({locateFile:()=>_T})),ap}const yT="Перетащите .step/.stp файл в область просмотра или воспользуйтесь панелью управления.",ST="Загружаем движок OpenCascade...";function bT(){const o=ot.useRef(null),e=ot.useRef(null),i=ot.useRef(null),r=ot.useRef(null),l=ot.useRef(null),f=ot.useRef(null),p=ot.useRef(0),m=ot.useRef(null),_=ot.useRef(new cb),x=ot.useRef(new Nt),b=ot.useRef(null),v=ot.useRef(null),E=-1e-4,[A,D]=ot.useState(ST),[N,T]=ot.useState(null),[M,W]=ot.useState(!1),[H,Y]=ot.useState(!1),[ee,V]=ot.useState(!1),[q,le]=ot.useState(!1),[P,O]=ot.useState("#ffad0d"),[Q,re]=ot.useState(null),oe=ot.useCallback(Ee=>{const F=b.current;if(F&&F.material instanceof Fr){const Be=F.userData.baseEmissiveHex;typeof Be=="number"&&F.material.emissive.setHex(Be)}Ee&&Ee.material instanceof Fr?(Ee.userData.baseEmissiveHex===void 0&&(Ee.userData.baseEmissiveHex=Ee.material.emissive.getHex()),Ee.material.emissive.setHex(2964090),b.current=Ee,re(Ee.name||"Без имени"),typeof Ee.userData.paintColorHex=="string"&&O(Ee.userData.paintColorHex)):(b.current=null,re(null))},[O]),be=ot.useCallback(Ee=>{const F=m.current;F&&F.traverse(Be=>{Be instanceof Yi&&Ee(Be)})},[]),Se=ot.useCallback((Ee,F)=>{const Be=e.current,tt=r.current,_t=m.current;if(!Be||!tt||!_t)return null;const We=Be.domElement.getBoundingClientRect();x.current.x=(Ee-We.left)/We.width*2-1,x.current.y=-((F-We.top)/We.height)*2+1,_.current.setFromCamera(x.current,tt);const He=_.current.intersectObjects(_t.children,!0).find(pt=>pt.object instanceof Yi&&pt.object.visible&&!pt.object.userData?.extinguished);return He?He.object:null},[]),B=ot.useCallback((Ee,F)=>{const Be=Se(Ee,F);return oe(Be),!!Be},[Se,oe]);ot.useEffect(()=>{let Ee=!0;return w_().then(()=>{Ee&&(le(!0),D(yT))}).catch(F=>{console.error(F),Ee&&(T("Не удалось загрузить движок OpenCascade"),D("Попробуйте обновить страницу"))}),()=>{Ee=!1}},[]),ot.useEffect(()=>{if(!o.current)return;const Ee=new KS;Ee.background=new Kt("#06070f"),i.current=Ee;const F=new J3({antialias:!0,alpha:!0});F.setPixelRatio(window.devicePixelRatio),e.current=F;const Be=new Wi(45,1,.1,2e3);Be.position.set(4,4,4),r.current=Be;const tt=new eT(Be,F.domElement);tt.enableDamping=!0,tt.dampingFactor=.08,l.current=tt;const _t=new ob(16777215,.6),We=new Kg(16777215,.85);We.position.set(5,10,4);const Bt=new Kg(16777215,.45);Bt.position.set(-4,-6,-5),Ee.add(_t,We,Bt);const He=new ub(60,60,3093826,1842985);He.position.y=E,(Array.isArray(He.material)?He.material:[He.material]).forEach(Re=>{Re.transparent=!0,Re.opacity=.4,Re.depthWrite=!1}),He.visible=!0,v.current=He,Ee.add(He);const I=o.current;I.appendChild(F.domElement);const R=Re=>{if(Re.button===2)return;const ie=Se(Re.clientX,Re.clientY);oe(ie)},se=()=>{if(!I||!r.current)return;const{clientWidth:Re,clientHeight:ie}=I;F.setSize(Re,ie);const Ye=r.current;Ye.aspect=Re/Math.max(ie,1),Ye.updateProjectionMatrix()};se(),window.addEventListener("resize",se),F.domElement.addEventListener("pointerdown",R);const Ae=()=>{tt.update(),F.render(Ee,Be),f.current=requestAnimationFrame(Ae)};return Ae(),()=>{window.removeEventListener("resize",se),F.domElement.removeEventListener("pointerdown",R),f.current&&cancelAnimationFrame(f.current),tt.dispose(),F.dispose(),v.current&&i.current?.children.includes(v.current)&&i.current.remove(v.current),v.current=null,I.contains(F.domElement)&&I.removeChild(F.domElement)}},[oe,Se]);const X=ot.useCallback(()=>{!i.current||!m.current||(i.current.remove(m.current),m.current.traverse(Ee=>{Ee instanceof Yi&&(Ee.geometry.dispose(),Array.isArray(Ee.material)?Ee.material.forEach(F=>F.dispose()):Ee.material.dispose())}),m.current=null,v.current&&(v.current.visible=!0,v.current.position.y=E),oe(null))},[oe]),$=ot.useCallback(Ee=>{const F=r.current,Be=l.current;if(!F||!Be)return;Ee.updateMatrixWorld(!0);const tt=new Bo().setFromObject(Ee),_t=tt.getSize(new me),We=tt.getCenter(new me);Ee.position.sub(We);const Bt=Math.max(_t.x,_t.y,_t.z),He=Bt===0?5:Bt*1.6,pt=new me(1.5,1,1.2).normalize();F.position.copy(pt.multiplyScalar(He)),F.near=Math.max(He/200,.01),F.far=He*20,F.updateProjectionMatrix(),Be.target.set(0,0,0),Be.update()},[]),ye=ot.useCallback(Ee=>{if(!i.current)return;X();const F=new Xl;Ee.meshes.forEach((Be,tt)=>{const _t=new oa,We=Be.attributes.position?.array??[];_t.setAttribute("position",new Ni(We,3));const Bt=Be.attributes.normal?.array;Bt?.length?_t.setAttribute("normal",new Ni(Bt,3)):_t.computeVertexNormals(),Be.index?.array?.length&&_t.setIndex(Be.index.array);const He=Be.color??Be.brep_faces?.find(Ae=>Ae.color)?.color??[.82,.86,.92],pt=new Kt(He[0],He[1],He[2]),I=new Fr({color:pt,metalness:.15,roughness:.35,side:xa}),R=`#${pt.getHexString()}`,se=new Yi(_t,I);se.name=Be.name??`Mesh-${tt+1}`,se.userData.originalColorHex=R,se.userData.paintColorHex=R,F.add(se)}),i.current.add(F),m.current=F,V(!0),$(F),v.current&&(v.current.visible=!1),oe(null)},[X,$,oe]),Te=ot.useCallback(()=>{const Ee=b.current;return!Ee||!(Ee.material instanceof Fr)?!1:(Ee.material.color.set(P),Ee.material.needsUpdate=!0,Ee.userData.paintColorHex=P,!0)},[P]),G=ot.useCallback(Ee=>{const F=b.current;return!F||!(F.material instanceof Fr)?!1:(F.material.color.set(Ee),F.material.needsUpdate=!0,F.userData.paintColorHex=Ee,O(Ee),!0)},[]),pe=ot.useCallback(()=>{const Ee=b.current;if(!Ee||!(Ee.material instanceof Fr))return!1;const F=Ee.userData.originalColorHex||"#d5dde8";return Ee.material.color.set(F),Ee.material.needsUpdate=!0,Ee.userData.paintColorHex=F,!0},[]),Ue=ot.useCallback(()=>{const Ee=[];return be(F=>{if(!(F.material instanceof Fr))return;const Be=typeof F.userData.paintColorHex=="string"?F.userData.paintColorHex:`#${F.material.color.getHexString()}`;Ee.push({name:F.name||"",color:Be,visible:F.visible})}),Ee.length?{version:1,generatedAt:new Date().toISOString(),meshes:Ee}:null},[be]),Fe=ot.useCallback(Ee=>{if(!Ee||Ee.version!==1)return!1;const F=new Map,Be=[];return be(tt=>{Be.push(tt);const _t=tt.name||"__noname__";F.has(_t)||F.set(_t,[]),F.get(_t).push(tt)}),Be.length?(Ee.meshes.forEach((tt,_t)=>{const We=tt.name||"__noname__";let He=F.get(We)?.shift();if(He||(He=Be[_t]),!He||!(He.material instanceof Fr))return;const pt=tt.color||"#d5dde8";He.material.color.set(pt),He.material.needsUpdate=!0,He.userData.paintColorHex=pt,He.visible=tt.visible!==!1}),(!b.current||!b.current.visible)&&oe(null),!0):!1},[be,oe]),et=ot.useCallback(()=>{const Ee=b.current;return Ee?(Ee.visible=!1,Ee.userData.extinguished=!0,oe(null),!0):!1},[oe]),he=ot.useCallback(async(Ee,F)=>{W(!0),T(null),D(`Импортируем ${F}...`);try{const Be=await w_(),tt=new Uint8Array(Ee),_t=Be.ReadStepFile(tt,vT);if(!_t?.success||!_t.meshes?.length)throw new Error("OCCT вернул пустой результат");ye(_t),D(`Готово: ${F} (${_t.meshes.length} объектов)`)}catch(Be){console.error(Be),V(!1),v.current&&(v.current.visible=!0,v.current.position.y=E);const tt=Be instanceof Error?Be.message:"Неизвестная ошибка при импорте файла";T(tt),D("Импорт не удался")}finally{W(!1)}},[ye]),ve=ot.useCallback(async Ee=>{const F=await Ee.arrayBuffer();await he(F,Ee.name)},[he]),Xe=ot.useCallback(async Ee=>{const F=Ee.target.files?.[0];F&&await ve(F),Ee.target.value=""},[ve]),lt=ot.useCallback(async(Ee,F="пример",Be)=>{D(`Загружаем ${F}...`),T(null);try{const tt=await fetch(Ee);if(!tt.ok)throw new Error("Не удалось получить пример");const _t=await tt.arrayBuffer();await he(_t,Be??`${F}.step`)}catch(tt){console.error(tt),T(tt instanceof Error?tt.message:"Ошибка загрузки примера"),D("Попробуйте другой файл")}},[he]),dt=ot.useCallback(async Ee=>{Ee.preventDefault(),p.current=0,Y(!1);const F=Ee.dataTransfer.files?.[0];F&&await ve(F)},[ve]),Et=ot.useCallback(Ee=>{Ee.preventDefault(),Ee.dataTransfer.dropEffect="copy"},[]),rn=ot.useCallback(Ee=>{Ee.preventDefault(),p.current+=1,Y(!0)},[]),Lt=ot.useCallback(Ee=>{Ee.preventDefault(),p.current=Math.max(p.current-1,0),p.current===0&&Y(!1)},[]);return{canvasHostRef:o,status:A,error:N,isLoading:M,occtReady:q,hasModel:ee,isDragActive:H,controlsDisabled:!q||M,handleDragEnter:rn,handleDragLeave:Lt,handleDragOver:Et,handleDrop:dt,handleFileInput:Xe,loadSample:lt,selectionColor:P,setSelectionColor:O,selectedMeshName:Q,applyColorToSelection:Te,applyColorToSelectionWithValue:G,resetSelectionColor:pe,extinguishSelection:et,selectMeshAtScreenPosition:B,serializeSceneState:Ue,applySceneState:Fe}}function MT({canvasRef:o,hasModel:e,isDragActive:i,isLoading:r,isPanelOpen:l,panelId:f,onContextMenu:p,onTouchStart:m,onTouchMove:_,onTouchEnd:x,onDragEnter:b,onDragLeave:v,onDragOver:E,onDrop:A,onTogglePanel:D,children:N}){return it.jsxs("section",{className:`viewer ${i?"viewer--active":""}`,onContextMenu:p,onTouchStart:m,onTouchMove:_,onTouchEnd:x,onDragEnter:b,onDragOver:E,onDragLeave:v,onDrop:A,children:[it.jsx("div",{ref:o,className:"viewer__canvas"}),!e&&it.jsxs("div",{className:"viewer__placeholder",children:[it.jsx("p",{children:"Сюда можно перетащить .step/.stp файл."}),it.jsx("p",{className:"muted",children:"Либо воспользуйтесь панелью управления."})]}),i&&it.jsx("div",{className:"viewer__drop-hint",children:"Отпустите файл, чтобы начать импорт"}),r&&it.jsxs("div",{className:"viewer__loading","aria-live":"polite",children:[it.jsx("div",{className:"viewer__loading-spinner"}),it.jsx("p",{children:"Импортируем модель..."})]}),!l&&it.jsx("button",{type:"button",className:"panel-toggle","aria-expanded":!1,"aria-controls":f,onClick:D,children:"Меню"}),N]})}function ET({samples:o,disabled:e,onSelect:i}){return it.jsxs("section",{className:"sample-library","aria-label":"Библиотека примеров",children:[it.jsxs("div",{className:"sample-library__header",children:[it.jsx("p",{className:"section-label",children:"Библиотека примеров"}),it.jsx("span",{className:"sample-library__count",children:o.length})]}),it.jsxs("div",{className:"sample-library__list",children:[o.length===0&&it.jsxs("span",{className:"sample-library__empty",children:["Добавьте .step/.stp файлы в папку ",it.jsx("code",{children:"public/models"})]}),o.map(r=>it.jsxs("button",{type:"button",className:"sample-card",onClick:()=>i(r),disabled:e,title:`Открыть ${r.fileName}`,children:[it.jsx("span",{className:"sample-card__label",children:r.label}),it.jsx("span",{className:"sample-card__meta",children:r.fileName})]},r.fileName))]})]})}function TT({className:o,ariaHidden:e,error:i,isLoading:r,controlsDisabled:l,onFileChange:f,onHidePanel:p,selectionColor:m,onSelectionColorChange:_,selectedMeshName:x,onApplyColor:b,onResetColor:v,colorPalette:E,onSelectPaletteColor:A,onAddPaletteColor:D,onRemovePaletteColor:N,canAddPaletteColor:T,onSaveSceneState:M,onLoadSceneState:W,sceneStateDisabled:H,samples:Y,onSampleSelect:ee,children:V}){const q=ot.useRef(null),le=P=>{const O=P.target.files?.[0];O&&W(O),P.target.value=""};return it.jsxs("aside",{id:"control-panel",className:o,"aria-hidden":e,children:[it.jsx("button",{type:"button",className:"panel-close",onClick:p,"aria-label":"Скрыть меню",children:it.jsx("span",{"aria-hidden":"true",children:"←"})}),it.jsxs("div",{className:"panel__header",children:[it.jsx("p",{className:"eyebrow",children:"WebAssembly + three.js"}),it.jsx("h1",{children:"STEP 3D Viewer"})]}),it.jsxs("div",{className:"controls",children:[it.jsxs("label",{className:"file-input","data-disabled":l,children:[it.jsx("input",{type:"file",accept:".step,.stp,.STEP,.STP,model/step,application/step",onChange:f,disabled:l}),it.jsx("span",{children:"Выбрать .step файл"})]}),r&&it.jsx("div",{className:"loader","aria-live":"polite"})]}),it.jsx(ET,{samples:Y,disabled:l,onSelect:ee}),i&&it.jsx("div",{className:"error-banner",children:i}),it.jsxs("div",{className:"color-controls",children:[it.jsxs("div",{className:"color-input",children:[it.jsx("label",{htmlFor:"color-picker",children:"Цвет"}),it.jsx("input",{id:"color-picker",type:"color",value:m,onChange:_,"aria-label":"Выбор цвета для выделения"})]}),it.jsxs("div",{className:"selection-info",children:[it.jsx("span",{className:"selection-label",children:x?`Выбрано: ${x}`:"Ничего не выбрано"}),it.jsxs("div",{className:"selection-actions",children:[it.jsx("button",{type:"button",className:"ghost",onClick:b,disabled:!x,children:"Применить"}),it.jsx("button",{type:"button",className:"ghost",onClick:v,disabled:!x,children:"Сбросить"})]})]})]}),it.jsxs("div",{className:"color-palette",children:[it.jsxs("div",{className:"color-palette__header",children:[it.jsx("p",{className:"section-label",children:"Палитра"}),it.jsx("button",{type:"button",className:"ghost",onClick:D,disabled:!T,children:"Добавить цвет"})]}),it.jsxs("div",{className:"color-palette__list",children:[E.map(P=>it.jsxs("button",{type:"button",className:"color-swatch","aria-label":`Цвет ${P}`,onClick:()=>A(P),style:{background:P},children:[it.jsx("span",{className:"color-swatch__value",children:P.toUpperCase()}),it.jsx("span",{className:"color-swatch__remove",role:"button","aria-label":"Удалить цвет из палитры",onClick:O=>{O.stopPropagation(),N(P)},children:"×"})]},P)),E.length===0&&it.jsx("p",{className:"color-palette__empty",children:"Пока пусто — добавьте текущий цвет."})]})]}),it.jsxs("div",{className:"scene-state-actions",children:[it.jsx("p",{className:"section-label",children:"Изменения"}),it.jsxs("div",{className:"scene-state-actions__buttons",children:[it.jsx("button",{type:"button",className:"ghost",onClick:M,disabled:H,children:"Сохранить"}),it.jsx("button",{type:"button",className:"ghost",onClick:()=>q.current?.click(),disabled:H,children:"Загрузить"})]}),it.jsx("input",{ref:q,type:"file",accept:"application/json",onChange:le,style:{display:"none"}})]}),V]})}function AT({x:o,y:e,onExtinguish:i,onChangeColor:r,currentColor:l,palette:f,onPaletteColorSelect:p,canApplyColor:m}){const _=x=>{x.stopPropagation()};return it.jsxs("div",{className:"context-menu",style:{top:`${e}px`,left:`${o}px`},role:"menu",onClick:_,onPointerDown:_,children:[it.jsxs("div",{className:"context-menu__group",children:[it.jsx("p",{className:"context-menu__label",children:"Цвет выделения"}),it.jsx("input",{type:"color","aria-label":"Выбрать цвет выделенного тела",value:l,onChange:x=>r(x.target.value)})]}),f.length>0&&it.jsxs("div",{className:"context-menu__palette",children:[it.jsx("p",{className:"context-menu__label",children:"Палитра"}),it.jsx("div",{className:"context-menu__swatches",children:f.map(x=>it.jsx("button",{type:"button",className:"context-menu__swatch",style:{background:x},onClick:()=>p(x),disabled:!m,"aria-label":`Применить цвет ${x}`,children:x.toUpperCase()},x))})]}),it.jsx("button",{type:"button",role:"menuitem",onClick:i,children:"Погасить выделенное тело"})]})}const wT=[{fileName:"ins100.stp",url:"/step-3d-viewer/models/ins100.stp"},{fileName:"masterpact-lv864962.stp",url:"/step-3d-viewer/models/masterpact-lv864962.stp"},{fileName:"nsx-lv432956.stp",url:"/step-3d-viewer/models/nsx-lv432956.stp"}],RT=o=>o.replace(/\.(step|stp)$/i,"").replace(/[-_]+/g," "),CT=wT.map(({fileName:o,url:e})=>({label:RT(o),fileName:o,url:e})).sort((o,e)=>o.label.localeCompare(e.label,"ru"));function DT(){const o=bT(),{selectMeshAtScreenPosition:e,selectedMeshName:i,serializeSceneState:r,applySceneState:l,hasModel:f}=o,[p,m]=ot.useState(!1),[_,x]=ot.useState(!1),[b,v]=ot.useState(null),E=ot.useRef(null),A=ot.useRef(null),[D,N]=ot.useState(["#ff920dff","#4c6dffff","#8bc34aff","#ff0000ff"]);ot.useEffect(()=>{const X=window.matchMedia("(max-width: 768px)"),$=Te=>{x(Te),Te&&m(!1)};$(X.matches);const ye=Te=>{$(Te.matches),Te.matches&&m(!1)};return X.addEventListener?X.addEventListener("change",ye):X.addListener(ye),()=>{X.removeEventListener?X.removeEventListener("change",ye):X.removeListener(ye)}},[]);const T=ot.useMemo(()=>["control-panel",_?"control-panel--mobile":"",p?"control-panel--open":"control-panel--collapsed"].filter(Boolean).join(" "),[_,p]),M="control-panel",W=o.selectionColor.toLowerCase(),H=ot.useMemo(()=>!D.includes(W),[D,W]),Y=ot.useCallback(()=>{const X=r();if(!X){alert("Нет модели для сохранения.");return}const $=new Blob([JSON.stringify(X,null,2)],{type:"application/json"}),ye=URL.createObjectURL($),Te=document.createElement("a");Te.href=ye,Te.download=`step-viewer-state-${new Date().toISOString().replace(/[:.]/g,"-")}.json`,Te.click(),URL.revokeObjectURL(ye)},[r]),ee=ot.useCallback(async X=>{try{const $=await X.text(),ye=JSON.parse($);l(ye)||alert("Не удалось применить сохранённое состояние.")}catch($){console.error($),alert("Не удалось прочитать файл состояния.")}},[l]),V=ot.useCallback(X=>{o.setSelectionColor(X)},[o]),q=ot.useCallback(()=>{N(X=>X.includes(W)?X:[...X,W])},[W]),le=ot.useCallback(X=>{N($=>$.filter(ye=>ye!==X))},[]),P=ot.useCallback(X=>{o.applyColorToSelectionWithValue(X),v(null)},[o]),O=ot.useCallback(()=>{E.current!==null&&(window.clearTimeout(E.current),E.current=null)},[]),Q=ot.useCallback((X,$)=>!e(X,$)&&!i?(v(null),!1):(v({x:X,y:$}),!0),[e,i]),re=ot.useCallback(X=>{X.preventDefault(),X.stopPropagation(),Q(X.clientX,X.clientY)},[Q]),oe=ot.useCallback(X=>{if(X.touches.length!==1){O();return}const $=X.touches[0];A.current={x:$.clientX,y:$.clientY},O(),E.current=window.setTimeout(()=>{const ye=A.current;ye&&(Q(ye.x,ye.y),O())},550)},[O,Q]),be=ot.useCallback(X=>{if(!A.current)return;const $=X.touches[0],ye=$.clientX-A.current.x,Te=$.clientY-A.current.y;Math.hypot(ye,Te)>15&&O()},[O]),Se=ot.useCallback(()=>{O(),A.current=null},[O]);ot.useEffect(()=>{if(!b)return;const X=ye=>{ye.button!==0&&ye.pointerType!=="touch"||v(null)},$=()=>v(null);return window.addEventListener("pointerdown",X),window.addEventListener("resize",$),()=>{window.removeEventListener("pointerdown",X),window.removeEventListener("resize",$)}},[b]),ot.useEffect(()=>()=>{O()},[O]),ot.useEffect(()=>{i||v(null)},[i]);const B=()=>{o.extinguishSelection(),v(null)};return it.jsx("div",{className:"app","data-panel-open":p,"data-mobile-layout":_,children:it.jsxs(MT,{canvasRef:o.canvasHostRef,hasModel:o.hasModel,isDragActive:o.isDragActive,isLoading:o.isLoading,isPanelOpen:p,panelId:M,onContextMenu:re,onTouchStart:oe,onTouchMove:be,onTouchEnd:Se,onDragEnter:o.handleDragEnter,onDragLeave:o.handleDragLeave,onDragOver:o.handleDragOver,onDrop:o.handleDrop,onTogglePanel:()=>m(!0),children:[it.jsx(TT,{className:T,ariaHidden:!p,error:o.error,isLoading:o.isLoading,controlsDisabled:o.controlsDisabled,onFileChange:o.handleFileInput,onHidePanel:()=>m(!1),selectionColor:o.selectionColor,onSelectionColorChange:X=>o.setSelectionColor(X.target.value),selectedMeshName:o.selectedMeshName,onApplyColor:o.applyColorToSelection,onResetColor:o.resetSelectionColor,colorPalette:D,onSelectPaletteColor:V,onAddPaletteColor:q,onRemovePaletteColor:le,canAddPaletteColor:H,onSaveSceneState:Y,onLoadSceneState:ee,sceneStateDisabled:!f,samples:CT,onSampleSelect:X=>o.loadSample(X.url,X.label,X.fileName)}),b&&it.jsx(AT,{x:b.x,y:b.y,onExtinguish:B,onChangeColor:X=>o.applyColorToSelectionWithValue(X),currentColor:o.selectionColor,palette:D,onPaletteColorSelect:P,canApplyColor:!!o.selectedMeshName})]})})}Oy.createRoot(document.getElementById("root")).render(it.jsx(ot.StrictMode,{children:it.jsx(DT,{})}));"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/step-3d-viewer/sw.js").catch(e=>{console.error("Service worker registration failed:",e)})});
