...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ja,depthTest:!1,depthWrite:!1})}function o1(s,e,i){const r=new Float32Array(vs),l=new xe(0,1,0);return new er({name:"SphericalGaussianBlur",defines:{n:vs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:tf(),fragmentShader:`
	...
	`}function l1(s){let e=new WeakMap,i=null;function r(m){if(m&&m.isTexture){const _=m.mapping,g=_===mp||_===gp,b=_===No||_===Oo;if(g||b){let S=e.get(m);const E=S!==void 0?S.texture.pmremVersion:0;if(m.isRenderTargetTexture&&m.pmremVersion!==E)return i===null&&(i=new a_(s)),S=g?i.fromEquirectangular(m,S):i.fromCubemap(m,S),S.texture.pmremVersion=m.pmremVersion,e.set(m,S),S.texture;if(S!==void 0)return S.texture;{const A=m.image;return g&&A&&A.height>0||b&&A&&l(A)?(i===null&&(i=new a_(s)),S=g?i.fromEquirectangular(m):i.fromCubemap(m),S.texture.pmremVersion=m.pmremVersion,e.set(m,S),m.addEventListener("dispose",f),S.texture):null}}}return m}function l(m){let _=0;const g=6;for(let b=0;b<g;b++)m[b]!==void 0&&_++;return _===g}function f(m){const _=m.target;_.removeEventListener("dispose",f);const g=e.get(_);g!==void 0&&(e.delete(_),g.dispose())}function p(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:p}}function c1(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const l=s.getExtension(r);return e[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&Kl("WebGLRenderer: "+r+" extension not supported."),l}}}function u1(s,e,i,r){const l={},f=new WeakMap;function p(S){const E=S.target;E.index!==null&&e.remove(E.index);for(const U in E.attributes)e.remove(E.attributes[U]);E.removeEventListener("dispose",p),delete l[E.id];const A=f.get(E);A&&(e.remove(A),f.delete(E)),r.releaseStatesOfGeometry(E),E.isInstancedBufferGeometry===!0&&delete E._maxInstanceCount,i.memory.geometries--}function m(S,E){return l[E.id]===!0||(E.addEventListener("dispose",p),l[E.id]=!0,i.memory.geometries++),E}function _(S){const E=S.attributes;for(const A in E)e.update(E[A],s.ARRAY_BUFFER)}function g(S){const E=[],A=S.index,U=S.attributes.position;let L=0;if(A!==null){const X=A.array;L=A.version;for(let H=0,q=X.length;H<q;H+=3){const Q=X[H+0],V=X[H+1],k=X[H+2];E.push(Q,V,V,k,k,Q)}}else if(U!==void 0){const X=U.array;L=U.version;for(let H=0,q=X.length/3-1;H<q;H+=3){const Q=H+0,V=H+1,k=H+2;E.push(Q,V,V,k,k,Q)}}else return;const T=new(V_(E)?q_:W_)(E,1);T.version=L;const M=f.get(S);M&&e.remove(M),f.set(S,T)}function b(S){const E=f.get(S);if(E){const A=S.index;A!==null&&E.version<A.version&&g(S)}else g(S);return f.get(S)}return{get:m,update:_,getWireframeAttribute:b}}function f1(s,e,i){let r;function l(E){r=E}let f,p;function m(E){f=E.type,p=E.bytesPerElement}function _(E,A){s.drawElements(r,A,f,E*p),i.update(A,r,1)}function g(E,A,U){U!==0&&(s.drawElementsInstanced(r,A,f,E*p,U),i.update(A,r,U))}function b(E,A,U){if(U===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,A,0,f,E,0,U);let T=0;for(let M=0;M<U;M++)T+=A[M];i.update(T,r,1)}function S(E,A,U,L){if(U===0)return;const T=e.get("WEBGL_multi_draw");if(T===null)for(let M=0;M<E.length;M++)g(E[M]/p,A[M],L[M]);else{T.multiDrawElementsInstancedWEBGL(r,A,0,f,E,0,L,0,U);let M=0;for(let X=0;X<U;X++)M+=A[X]*L[X];i.update(M,r,1)}}this.setMode=l,this.setIndex=m,this.render=_,this.renderInstances=g,this.renderMultiDraw=b,this.renderMultiDrawInstances=S}function h1(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(f,p,m){switch(i.calls++,p){case s.TRIANGLES:i.triangles+=m*(f/3);break;case s.LINES:i.lines+=m*(f/2);break;case s.LINE_STRIP:i.lines+=m*(f-1);break;case s.LINE_LOOP:i.lines+=m*f;break;case s.POINTS:i.points+=m*f;break;default:Cn("WebGLInfo: Unknown draw mode:",p);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:r}}function d1(s,e,i){const r=new WeakMap,l=new Dn;function f(p,m,_){const g=p.morphTargetInfluences,b=m.morphAttributes.position||m.morphAttributes.normal||m.morphAttributes.color,S=b!==void 0?b.length:0;let E=r.get(m);if(E===void 0||E.count!==S){let O=function(){ue.dispose(),r.delete(m),m.removeEventListener("dispose",O)};var A=O;E!==void 0&&E.texture.dispose();const U=m.morphAttributes.position!==void 0,L=m.morphAttributes.normal!==void 0,T=m.morphAttributes.color!==void 0,M=m.morphAttributes.position||[],X=m.morphAttributes.normal||[],H=m.morphAttributes.color||[];let q=0;U===!0&&(q=1),L===!0&&(q=2),T===!0&&(q=3);let Q=m.attributes.position.count*q,V=1;Q>e.maxTextureSize&&(V=Math.ceil(Q/e.maxTextureSize),Q=e.maxTextureSize);const k=new Float32Array(Q*V*4*S),ue=new G_(k,Q,V,S);ue.type=Qa,ue.needsUpdate=!0;const F=q*4;for(let K=0;K<S;K++){const ae=M[K],le=X[K],Te=H[K],Me=Q*V*4*K;for(let B=0;B<ae.count;B++){const $=B*F;U===!0&&(l.fromBufferAttribute(ae,B),k[Me+$+0]=l.x,k[Me+$+1]=l.y,k[Me+$+2]=l.z,k[Me+$+3]=0),L===!0&&(l.fromBufferAttribute(le,B),k[Me+$+4]=l.x,k[Me+$+5]=l.y,k[Me+$+6]=l.z,k[Me+$+7]=0),T===!0&&(l.fromBufferAttribute(Te,B),k[Me+$+8]=l.x,k[Me+$+9]=l.y,k[Me+$+10]=l.z,k[Me+$+11]=Te.itemSize===4?l.w:1)}}E={count:S,texture:ue,size:new Dt(Q,V)},r.set(m,E),m.addEventListener("dispose",O)}if(p.isInstancedMesh===!0&&p.morphTexture!==null)_.getUniforms().setValue(s,"morphTexture",p.morphTexture,i);else{let U=0;for(let T=0;T<g.length;T++)U+=g[T];const L=m.morphTargetsRelative?1:1-U;_.getUniforms().setValue(s,"morphTargetBaseInfluence",L),_.getUniforms().setValue(s,"morphTargetInfluences",g)}_.getUniforms().setValue(s,"morphTargetsTexture",E.texture,i),_.getUniforms().setValue(s,"morphTargetsTextureSize",E.size)}return{update:f}}function p1(s,e,i,r){let l=new WeakMap;function f(_){const g=r.render.frame,b=_.geometry,S=e.get(_,b);if(l.get(S)!==g&&(e.update(S),l.set(S,g)),_.isInstancedMesh&&(_.hasEventListener("dispose",m)===!1&&_.addEventListener("dispose",m),l.get(_)!==g&&(i.update(_.instanceMatrix,s.ARRAY_BUFFER),_.instanceColor!==null&&i.update(_.instanceColor,s.ARRAY_BUFFER),l.set(_,g))),_.isSkinnedMesh){const E=_.skeleton;l.get(E)!==g&&(E.update(),l.set(E,g))}return S}function p(){l=new WeakMap}function m(_){const g=_.target;g.removeEventListener("dispose",m),i.remove(g.instanceMatrix),g.instanceColor!==null&&i.remove(g.instanceColor)}return{update:f,dispose:p}}const nv=new pi,l_=new Q_(1,1),iv=new G_,av=new OS,rv=new Z_,c_=[],u_=[],f_=new Float32Array(16),h_=new Float32Array(9),d_=new Float32Array(4);function Ho(s,e,i){const r=s[0];if(r<=0||r>0)return s;const l=e*i;let f=c_[l];if(f===void 0&&(f=new Float32Array(l),c_[l]=f),e!==0){r.toArray(f,0);for(let p=1,m=0;p!==e;++p)m+=i,s[p].toArray(f,m)}return f}function Wn(s,e){if(s.length!==e.length)return!1;for(let i=0,r=s.length;i<r;i++)if(s[i]!==e[i])return!1;return!0}function qn(s,e){for(let i=0,r=e.length;i<r;i++)s[i]=e[i]}function nf(s,e){let i=u_[e];i===void 0&&(i=new Int32Array(e),u_[e]=i);for(let r=0;r!==e;++r)i[r]=s.allocateTextureUnit();return i}function m1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1f(this.addr,e),i[0]=e)}function g1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(Wn(i,e))return;s.uniform2fv(this.addr,e),qn(i,e)}}function x1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(Wn(i,e))return;s.uniform3fv(this.addr,e),qn(i,e)}}function _1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(Wn(i,e))return;s.uniform4fv(this.addr,e),qn(i,e)}}function v1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(Wn(i,e))return;s.uniformMatrix2fv(this.addr,!1,e),qn(i,e)}else{if(Wn(i,r))return;d_.set(r),s.uniformMatrix2fv(this.addr,!1,d_),qn(i,r)}}function y1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(Wn(i,e))return;s.uniformMatrix3fv(this.addr,!1,e),qn(i,e)}else{if(Wn(i,r))return;h_.set(r),s.uniformMatrix3fv(this.addr,!1,h_),qn(i,r)}}function S1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(Wn(i,e))return;s.uniformMatrix4fv(this.addr,!1,e),qn(i,e)}else{if(Wn(i,r))return;f_.set(r),s.uniformMatrix4fv(this.addr,!1,f_),qn(i,r)}}function b1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1i(this.addr,e),i[0]=e)}function M1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(Wn(i,e))return;s.uniform2iv(this.addr,e),qn(i,e)}}function E1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(Wn(i,e))return;s.uniform3iv(this.addr,e),qn(i,e)}}function T1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(Wn(i,e))return;s.uniform4iv(this.addr,e),qn(i,e)}}function A1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1ui(this.addr,e),i[0]=e)}function w1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(Wn(i,e))return;s.uniform2uiv(this.addr,e),qn(i,e)}}function R1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(Wn(i,e))return;s.uniform3uiv(this.addr,e),qn(i,e)}}function C1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(Wn(i,e))return;s.uniform4uiv(this.addr,e),qn(i,e)}}function D1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l);let f;this.type===s.SAMPLER_2D_SHADOW?(l_.compareFunction=H_,f=l_):f=nv,i.setTexture2D(e||f,l)}function U1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(e||av,l)}function L1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(e||rv,l)}function N1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(e||iv,l)}function O1(s){switch(s){case 5126:return m1;case 35664:return g1;case 35665:return x1;case 35666:return _1;case 35674:return v1;case 35675:return y1;case 35676:return S1;case 5124:case 35670:return b1;case 35667:case 35671:return M1;case 35668:case 35672:return E1;case 35669:case 35673:return T1;case 5125:return A1;case 36294:return w1;case 36295:return R1;case 36296:return C1;case 35678:case 36198:case 36298:case 36306:case 35682:return D1;case 35679:case 36299:case 36307:return U1;case 35680:case 36300:case 36308:case 36293:return L1;case 36289:case 36303:case 36311:case 36292:return N1}}function P1(s,e){s.uniform1fv(this.addr,e)}function F1(s,e){const i=Ho(e,this.size,2);s.uniform2fv(this.addr,i)}function z1(s,e){const i=Ho(e,this.size,3);s.uniform3fv(this.addr,i)}function B1(s,e){const i=Ho(e,this.size,4);s.uniform4fv(this.addr,i)}function I1(s,e){const i=Ho(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function H1(s,e){const i=Ho(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function V1(s,e){const i=Ho(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function G1(s,e){s.uniform1iv(this.addr,e)}function k1(s,e){s.uniform2iv(this.addr,e)}function X1(s,e){s.uniform3iv(this.addr,e)}function W1(s,e){s.uniform4iv(this.addr,e)}function q1(s,e){s.uniform1uiv(this.addr,e)}function Y1(s,e){s.uniform2uiv(this.addr,e)}function j1(s,e){s.uniform3uiv(this.addr,e)}function Z1(s,e){s.uniform4uiv(this.addr,e)}function K1(s,e,i){const r=this.cache,l=e.length,f=nf(i,l);Wn(r,f)||(s.uniform1iv(this.addr,f),qn(r,f));for(let p=0;p!==l;++p)i.setTexture2D(e[p]||nv,f[p])}function Q1(s,e,i){const r=this.cache,l=e.length,f=nf(i,l);Wn(r,f)||(s.uniform1iv(this.addr,f),qn(r,f));for(let p=0;p!==l;++p)i.setTexture3D(e[p]||av,f[p])}function J1(s,e,i){const r=this.cache,l=e.length,f=nf(i,l);Wn(r,f)||(s.uniform1iv(this.addr,f),qn(r,f));for(let p=0;p!==l;++p)i.setTextureCube(e[p]||rv,f[p])}function $1(s,e,i){const r=this.cache,l=e.length,f=nf(i,l);Wn(r,f)||(s.uniform1iv(this.addr,f),qn(r,f));for(let p=0;p!==l;++p)i.setTexture2DArray(e[p]||iv,f[p])}function e3(s){switch(s){case 5126:return P1;case 35664:return F1;case 35665:return z1;case 35666:return B1;case 35674:return I1;case 35675:return H1;case 35676:return V1;case 5124:case 35670:return G1;case 35667:case 35671:return k1;case 35668:case 35672:return X1;case 35669:case 35673:return W1;case 5125:return q1;case 36294:return Y1;case 36295:return j1;case 36296:return Z1;case 35678:case 36198:case 36298:case 36306:case 35682:return K1;case 35679:case 36299:case 36307:return Q1;case 35680:case 36300:case 36308:case 36293:return J1;case 36289:case 36303:case 36311:case 36292:return $1}}class t3{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.setValue=O1(i.type)}}class n3{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=e3(i.type)}}class i3{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,r){const l=this.seq;for(let f=0,p=l.length;f!==p;++f){const m=l[f];m.setValue(e,i[m.id],r)}}}const tp=/(\w+)(\])?(\[|\.)?/g;function p_(s,e){s.seq.push(e),s.map[e.id]=e}function a3(s,e,i){const r=s.name,l=r.length;for(tp.lastIndex=0;;){const f=tp.exec(r),p=tp.lastIndex;let m=f[1];const _=f[2]==="]",g=f[3];if(_&&(m=m|0),g===void 0||g==="["&&p+2===l){p_(i,g===void 0?new t3(m,s,e):new n3(m,s,e));break}else{let S=i.map[m];S===void 0&&(S=new i3(m),p_(i,S)),i=S}}}class Xu{constructor(e,i){this.seq=[],this.map={};const r=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let l=0;l<r;++l){const f=e.getActiveUniform(i,l),p=e.getUniformLocation(i,f.name);a3(f,p,this)}}setValue(e,i,r,l){const f=this.map[i];f!==void 0&&f.setValue(e,r,l)}setOptional(e,i,r){const l=i[r];l!==void 0&&this.setValue(e,r,l)}static upload(e,i,r,l){for(let f=0,p=i.length;f!==p;++f){const m=i[f],_=r[m.id];_.needsUpdate!==!1&&m.setValue(e,_.value,l)}}static seqWithValue(e,i){const r=[];for(let l=0,f=e.length;l!==f;++l){const p=e[l];p.id in i&&r.push(p)}return r}}function m_(s,e,i){const r=s.createShader(e);return s.shaderSource(r,i),s.compileShader(r),r}const r3=37297;let s3=0;function o3(s,e){const i=s.split(`
`),r=[],l=Math.max(e-6,0),f=Math.min(e+6,i.length);for(let p=l;p<f;p++){const m=p+1;r.push(`${m===e?">":" "} ${m}: ${i[p]}`)}return r.join(`
`)}const g_=new Ft;function l3(s){tn._getMatrix(g_,tn.workingColorSpace,s);const e=`mat3( ${g_.elements.map(i=>i.toFixed(4))} )`;switch(tn.getTransfer(s)){case qu:return[e,"LinearTransferOETF"];case pn:return[e,"sRGBTransferOETF"];default:return wt("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function x_(s,e,i){const r=s.getShaderParameter(e,s.COMPILE_STATUS),f=(s.getShaderInfoLog(e)||"").trim();if(r&&f==="")return"";const p=/ERROR: 0:(\d+)/.exec(f);if(p){const m=parseInt(p[1]);return i.toUpperCase()+`

`+f+`

`+o3(s.getShaderSource(e),m)}else return f}function c3(s,e){const i=l3(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function u3(s,e){let i;switch(e){case oS:i="Linear";break;case lS:i="Reinhard";break;case cS:i="Cineon";break;case uS:i="ACESFilmic";break;case hS:i="AgX";break;case dS:i="Neutral";break;case fS:i="Custom";break;default:wt("WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const zu=new xe;function f3(){tn.getLuminanceCoefficients(zu);const s=zu.x.toFixed(4),e=zu.y.toFixed(4),i=zu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function h3(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Wl).join(`
`)}function d3(s){const e=[];for(const i in s){const r=s[i];r!==!1&&e.push("#define "+i+" "+r)}return e.join(`
`)}function p3(s,e){const i={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const f=s.getActiveAttrib(e,l),p=f.name;let m=1;f.type===s.FLOAT_MAT2&&(m=2),f.type===s.FLOAT_MAT3&&(m=3),f.type===s.FLOAT_MAT4&&(m=4),i[p]={type:f.type,location:s.getAttribLocation(e,p),locationSize:m}}return i}function Wl(s){return s!==""}function __(s,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function v_(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const m3=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zp(s){return s.replace(m3,x3)}const g3=new Map;function x3(s,e){let i=Bt[e];if(i===void 0){const r=g3.get(e);if(r!==void 0)i=Bt[r],wt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return Zp(i)}const _3=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function y_(s){return s.replace(_3,v3)}function v3(s,e,i,r){let l="";for(let f=parseInt(e);f<parseInt(i);f++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+f+" ]").replace(/UNROLLED_LOOP_INDEX/g,f);return l}function S_(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function y3(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===C_?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Hy?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Za&&(e="SHADOWMAP_TYPE_VSM"),e}function S3(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case No:case Oo:e="ENVMAP_TYPE_CUBE";break;case Qu:e="ENVMAP_TYPE_CUBE_UV";break}return e}function b3(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Oo:e="ENVMAP_MODE_REFRACTION";break}return e}function M3(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case D_:e="ENVMAP_BLENDING_MULTIPLY";break;case rS:e="ENVMAP_BLENDING_MIX";break;case sS:e="ENVMAP_BLENDING_ADD";break}return e}function E3(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function T3(s,e,i,r){const l=s.getContext(),f=i.defines;let p=i.vertexShader,m=i.fragmentShader;const _=y3(i),g=S3(i),b=b3(i),S=M3(i),E=E3(i),A=h3(i),U=d3(f),L=l.createProgram();let T,M,X=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+M);const H=X+T+p,q=X+M+m,Q=m_(l,l.VERTEX_SHADER,H),V=m_(l,l.FRAGMENT_SHADER,q);l.attachShader(L,Q),l.attachShader(L,V),i.index0AttributeName!==void 0?l.bindAttribLocation(L,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(L,0,"position"),l.linkProgram(L);function k(K){if(s.debug.checkShaderErrors){const ae=l.getProgramInfoLog(L)||"",le=l.getShaderInfoLog(Q)||"",Te=l.getShaderInfoLog(V)||"",Me=ae.trim(),B=le.trim(),$=Te.trim();let te=!0,Re=!0;if(l.getProgramParameter(L,l.LINK_STATUS)===!1)if(te=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,L,Q,V);else{const ce=x_(l,Q,"vertex"),I=x_(l,V,"fragment");Cn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(L,l.VALIDATE_STATUS)+`
...
}`;function V3(s,e,i){let r=new om;const l=new Dt,f=new Dt,p=new Dn,m=new sb({depthPacking:gS}),_=new ob,g={},b=i.maxTextureSize,S={[Vr]:Mi,[Mi]:Vr,[ga]:ga},E=new er({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:I3,fragmentShader:H3}),A=E.clone();A.defines.HORIZONTAL_PASS=1;const U=new oa;U.setAttribute("position",new _a(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const L=new Li(U,E),T=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=C_;let M=this.type;this.render=function(V,k,ue){if(T.enabled===!1||T.autoUpdate===!1&&T.needsUpdate===!1||V.length===0)return;const F=s.getRenderTarget(),O=s.getActiveCubeFace(),K=s.getActiveMipmapLevel(),ae=s.state;ae.setBlending(Ja),ae.buffers.depth.getReversed()===!0?ae.buffers.color.setClear(0,0,0,0):ae.buffers.color.setClear(1,1,1,1),ae.buffers.depth.setTest(!0),ae.setScissorTest(!1);const le=M!==Za&&this.type===Za,Te=M===Za&&this.type!==Za;for(let Me=0,B=V.length;Me<B;Me++){const $=V[Me],te=$.shadow;if(te===void 0){wt("WebGLShadowMap:",$,"has no shadow.");continue}if(te.autoUpdate===!1&&te.needsUpdate===!1)continue;l.copy(te.mapSize);const Re=te.getFrameExtents();if(l.multiply(Re),f.copy(te.mapSize),(l.x>b||l.y>b)&&(l.x>b&&(f.x=Math.floor(b/Re.x),l.x=f.x*Re.x,te.mapSize.x=f.x),l.y>b&&(f.y=Math.floor(b/Re.y),l.y=f.y*Re.y,te.mapSize.y=f.y)),te.map===null||le===!0||Te===!0){const I=this.type!==Za?{minFilter:Ni,magFilter:Ni}:{};te.map!==null&&te.map.dispose(),te.map=new Ms(l.x,l.y,I),te.map.texture.name=$.name+".shadowMap",te.camera.updateProjectionMatrix()}s.setRenderTarget(te.map),s.clear();const ce=te.getViewportCount();for(let I=0;I<ce;I++){const re=te.getViewport(I);p.set(f.x*re.x,f.y*re.y,f.x*re.z,f.y*re.w),ae.viewport(p),te.updateMatrices($,I),r=te.getFrustum(),q(k,ue,te.camera,$,this.type)}te.isPointLightShadow!==!0&&this.type===Za&&X(te,ue),te.needsUpdate=!1}M=this.type,T.needsUpdate=!1,s.setRenderTarget(F,O,K)};function X(V,k){const ue=e.update(L);E.defines.VSM_SAMPLES!==V.blurSamples&&(E.defines.VSM_SAMPLES=V.blurSamples,A.defines.VSM_SAMPLES=V.blurSamples,E.needsUpdate=!0,A.needsUpdate=!0),V.mapPass===null&&(V.mapPass=new Ms(l.x,l.y)),E.uniforms.shadow_pass.value=V.map.texture,E.uniforms.resolution.value=V.mapSize,E.uniforms.radius.value=V.radius,s.setRenderTarget(V.mapPass),s.clear(),s.renderBufferDirect(k,null,ue,E,L,null),A.uniforms.shadow_pass.value=V.mapPass.texture,A.uniforms.resolution.value=V.mapSize,A.uniforms.radius.value=V.radius,s.setRenderTarget(V.map),s.clear(),s.renderBufferDirect(k,null,ue,A,L,null)}function H(V,k,ue,F){let O=null;const K=ue.isPointLight===!0?V.customDistanceMaterial:V.customDepthMaterial;if(K!==void 0)O=K;else if(O=ue.isPointLight===!0?_:m,s.localClippingEnabled&&k.clipShadows===!0&&Array.isArray(k.clippingPlanes)&&k.clippingPlanes.length!==0||k.displacementMap&&k.displacementScale!==0||k.alphaMap&&k.alphaTest>0||k.map&&k.alphaTest>0||k.alphaToCoverage===!0){const ae=O.uuid,le=k.uuid;let Te=g[ae];Te===void 0&&(Te={},g[ae]=Te);let Me=Te[le];Me===void 0&&(Me=O.clone(),Te[le]=Me,k.addEventListener("dispose",Q)),O=Me}if(O.visible=k.visible,O.wireframe=k.wireframe,F===Za?O.side=k.shadowSide!==null?k.shadowSide:k.side:O.side=k.shadowSide!==null?k.shadowSide:S[k.side],O.alphaMap=k.alphaMap,O.alphaTest=k.alphaToCoverage===!0?.5:k.alphaTest,O.map=k.map,O.clipShadows=k.clipShadows,O.clippingPlanes=k.clippingPlanes,O.clipIntersection=k.clipIntersection,O.displacementMap=k.displacementMap,O.displacementScale=k.displacementScale,O.displacementBias=k.displacementBias,O.wireframeLinewidth=k.wireframeLinewidth,O.linewidth=k.linewidth,ue.isPointLight===!0&&O.isMeshDistanceMaterial===!0){const ae=s.properties.get(O);ae.light=ue}return O}function q(V,k,ue,F,O){if(V.visible===!1)return;if(V.layers.test(k.layers)&&(V.isMesh||V.isLine||V.isPoints)&&(V.castShadow||V.receiveShadow&&O===Za)&&(!V.frustumCulled||r.intersectsObject(V))){V.modelViewMatrix.multiplyMatrices(ue.matrixWorldInverse,V.matrixWorld);const le=e.update(V),Te=V.material;if(Array.isArray(Te)){const Me=le.groups;for(let B=0,$=Me.length;B<$;B++){const te=Me[B],Re=Te[te.materialIndex];if(Re&&Re.visible){const ce=H(V,Re,F,O);V.onBeforeShadow(s,V,k,ue,le,ce,te),s.renderBufferDirect(ue,null,le,ce,V,te),V.onAfterShadow(s,V,k,ue,le,ce,te)}}}else if(Te.visible){const Me=H(V,Te,F,O);V.onBeforeShadow(s,V,k,ue,le,Me,null),s.renderBufferDirect(ue,null,le,Me,V,null),V.onAfterShadow(s,V,k,ue,le,Me,null)}}const ae=V.children;for(let le=0,Te=ae.length;le<Te;le++)q(ae[le],k,ue,F,O)}function Q(V){V.target.removeEventListener("dispose",Q);for(const ue in g){const F=g[ue],O=V.target.uuid;O in F&&(F[O].dispose(),delete F[O])}}}const G3={[lp]:cp,[up]:dp,[fp]:pp,[Lo]:hp,[cp]:lp,[dp]:up,[pp]:fp,[hp]:Lo};function k3(s,e){function i(){let j=!1;const Ye=new Dn;let ke=null;const Xe=new Dn(0,0,0,0);return{setMask:function(Pe){ke!==Pe&&!j&&(s.colorMask(Pe,Pe,Pe,Pe),ke=Pe)},setLocked:function(Pe){j=Pe},setClear:function(Pe,Le,rt,Mt,st){st===!0&&(Pe*=Mt,Le*=Mt,rt*=Mt),Ye.set(Pe,Le,rt,Mt),Xe.equals(Ye)===!1&&(s.clearColor(Pe,Le,rt,Mt),Xe.copy(Ye))},reset:function(){j=!1,ke=null,Xe.set(-1,0,0,0)}}}function r(){let j=!1,Ye=!1,ke=null,Xe=null,Pe=null;return{setReversed:function(Le){if(Ye!==Le){const rt=e.get("EXT_clip_control");Le?rt.clipControlEXT(rt.LOWER_LEFT_EXT,rt.ZERO_TO_ONE_EXT):rt.clipControlEXT(rt.LOWER_LEFT_EXT,rt.NEGATIVE_ONE_TO_ONE_EXT),Ye=Le;const Mt=Pe;Pe=null,this.setClear(Mt)}},getReversed:function(){return Ye},setTest:function(Le){Le?Se(s.DEPTH_TEST):qe(s.DEPTH_TEST)},setMask:function(Le){ke!==Le&&!j&&(s.depthMask(Le),ke=Le)},setFunc:function(Le){if(Ye&&(Le=G3[Le]),Xe!==Le){switch(Le){case lp:s.depthFunc(s.NEVER);break;case cp:s.depthFunc(s.ALWAYS);break;case up:s.depthFunc(s.LESS);break;case Lo:s.depthFunc(s.LEQUAL);break;case fp:s.depthFunc(s.EQUAL);break;case hp:s.depthFunc(s.GEQUAL);break;case dp:s.depthFunc(s.GREATER);break;case pp:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Xe=Le}},setLocked:function(Le){j=Le},setClear:function(Le){Pe!==Le&&(Ye&&(Le=1-Le),s.clearDepth(Le),Pe=Le)},reset:function(){j=!1,ke=null,Xe=null,Pe=null,Ye=!1}}}function l(){let j=!1,Ye=null,ke=null,Xe=null,Pe=null,Le=null,rt=null,Mt=null,st=null;return{setTest:function(Qt){j||(Qt?Se(s.STENCIL_TEST):qe(s.STENCIL_TEST))},setMask:function(Qt){Ye!==Qt&&!j&&(s.stencilMask(Qt),Ye=Qt)},setFunc:function(Qt,Yn,li){(ke!==Qt||Xe!==Yn||Pe!==li)&&(s.stencilFunc(Qt,Yn,li),ke=Qt,Xe=Yn,Pe=li)},setOp:function(Qt,Yn,li){(Le!==Qt||rt!==Yn||Mt!==li)&&(s.stencilOp(Qt,Yn,li),Le=Qt,rt=Yn,Mt=li)},setLocked:function(Qt){j=Qt},setClear:function(Qt){st!==Qt&&(s.clearStencil(Qt),st=Qt)},reset:function(){j=!1,Ye=null,ke=null,Xe=null,Pe=null,Le=null,rt=null,Mt=null,st=null}}}const f=new i,p=new r,m=new l,_=new WeakMap,g=new WeakMap;let b={},S={},E=new WeakMap,A=[],U=null,L=!1,T=null,M=null,X=null,H=null,q=null,Q=null,V=null,k=new Zt(0,0,0),ue=0,F=!1,O=null,K=null,ae=null,le=null,Te=null;const Me=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,$=0;const te=s.getParameter(s.VERSION);te.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(te)[1]),B=$>=1):te.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),B=$>=2);let Re=null,ce={};const I=s.getParameter(s.SCISSOR_BOX),re=s.getParameter(s.VIEWPORT),we=new Dn().fromArray(I),ze=new Dn().fromArray(re);function et(j,Ye,ke,Xe){const Pe=new Uint8Array(4),Le=s.createTexture();s.bindTexture(j,Le),s.texParameteri(j,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(j,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let rt=0;rt<ke;rt++)j===s.TEXTURE_3D||j===s.TEXTURE_2D_ARRAY?s.texImage3D(Ye,0,s.RGBA,1,1,Xe,0,s.RGBA,s.UNSIGNED_BYTE,Pe):s.texImage2D(Ye+rt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Pe);return Le}const me={};me[s.TEXTURE_2D]=et(s.TEXTURE_2D,s.TEXTURE_2D,1),me[s.TEXTURE_CUBE_MAP]=et(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),me[s.TEXTURE_2D_ARRAY]=et(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),me[s.TEXTURE_3D]=et(s.TEXTURE_3D,s.TEXTURE_3D,1,1),f.setClear(0,0,0,1),p.setClear(1),m.setClear(0),Se(s.DEPTH_TEST),p.setFunc(Lo),Et(!1),Ut(yx),Se(s.CULL_FACE),Ot(Ja);function Se(j){b[j]!==!0&&(s.enable(j),b[j]=!0)}function qe(j){b[j]!==!1&&(s.disable(j),b[j]=!1)}function lt(j,Ye){return S[j]!==Ye?(s.bindFramebuffer(j,Ye),S[j]=Ye,j===s.DRAW_FRAMEBUFFER&&(S[s.FRAMEBUFFER]=Ye),j===s.FRAMEBUFFER&&(S[s.DRAW_FRAMEBUFFER]=Ye),!0):!1}function ft(j,Ye){let ke=A,Xe=!1;if(j){ke=E.get(Ye),ke===void 0&&(ke=[],E.set(Ye,ke));const Pe=j.textures;if(ke.length!==Pe.length||ke[0]!==s.COLOR_ATTACHMENT0){for(let Le=0,rt=Pe.length;Le<rt;Le++)ke[Le]=s.COLOR_ATTACHMENT0+Le;ke.length=Pe.length,Xe=!0}}else ke[0]!==s.BACK&&(ke[0]=s.BACK,Xe=!0);Xe&&s.drawBuffers(ke)}function yt(j){return U!==j?(s.useProgram(j),U=j,!0):!1}const rn={[_s]:s.FUNC_ADD,[Gy]:s.FUNC_SUBTRACT,[ky]:s.FUNC_REVERSE_SUBTRACT};rn[Xy]=s.MIN,rn[Wy]=s.MAX;const Tt={[qy]:s.ZERO,[Yy]:s.ONE,[jy]:s.SRC_COLOR,[sp]:s.SRC_ALPHA,[eS]:s.SRC_ALPHA_SATURATE,[Jy]:s.DST_COLOR,[Ky]:s.DST_ALPHA,[Zy]:s.ONE_MINUS_SRC_COLOR,[op]:s.ONE_MINUS_SRC_ALPHA,[$y]:s.ONE_MINUS_DST_COLOR,[Qy]:s.ONE_MINUS_DST_ALPHA,[tS]:s.CONSTANT_COLOR,[nS]:s.ONE_MINUS_CONSTANT_COLOR,[iS]:s.CONSTANT_ALPHA,[aS]:s.ONE_MINUS_CONSTANT_ALPHA};function Ot(j,Ye,ke,Xe,Pe,Le,rt,Mt,st,Qt){if(j===Ja){L===!0&&(qe(s.BLEND),L=!1);return}if(L===!1&&(Se(s.BLEND),L=!0),j!==Vy){if(j!==T||Qt!==F){if((M!==_s||q!==_s)&&(s.blendEquation(s.FUNC_ADD),M=_s,q=_s),Qt)switch(j){case Do:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Sx:s.blendFunc(s.ONE,s.ONE);break;case bx:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Mx:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:Cn("WebGLState: Invalid blending: ",j);break}else switch(j){case Do:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Sx:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case bx:Cn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Mx:Cn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Cn("WebGLState: Invalid blending: ",j);break}X=null,H=null,Q=null,V=null,k.set(0,0,0),ue=0,T=j,F=Qt}return}Pe=Pe||Ye,Le=Le||ke,rt=rt||Xe,(Ye!==M||Pe!==q)&&(s.blendEquationSeparate(rn[Ye],rn[Pe]),M=Ye,q=Pe),(ke!==X||Xe!==H||Le!==Q||rt!==V)&&(s.blendFuncSeparate(Tt[ke],Tt[Xe],Tt[Le],Tt[rt]),X=ke,H=Xe,Q=Le,V=rt),(Mt.equals(k)===!1||st!==ue)&&(s.blendColor(Mt.r,Mt.g,Mt.b,st),k.copy(Mt),ue=st),T=j,F=!1}function Y(j,Ye){j.side===ga?qe(s.CULL_FACE):Se(s.CULL_FACE);let ke=j.side===Mi;Ye&&(ke=!ke),Et(ke),j.blending===Do&&j.transparent===!1?Ot(Ja):Ot(j.blending,j.blendEquation,j.blendSrc,j.blendDst,j.blendEquationAlpha,j.blendSrcAlpha,j.blendDstAlpha,j.blendColor,j.blendAlpha,j.premultipliedAlpha),p.setFunc(j.depthFunc),p.setTest(j.depthTest),p.setMask(j.depthWrite),f.setMask(j.colorWrite);const Xe=j.stencilWrite;m.setTest(Xe),Xe&&(m.setMask(j.stencilWriteMask),m.setFunc(j.stencilFunc,j.stencilRef,j.stencilFuncMask),m.setOp(j.stencilFail,j.stencilZFail,j.stencilZPass)),at(j.polygonOffset,j.polygonOffsetFactor,j.polygonOffsetUnits),j.alphaToCoverage===!0?Se(s.SAMPLE_ALPHA_TO_COVERAGE):qe(s.SAMPLE_ALPHA_TO_COVERAGE)}function Et(j){O!==j&&(j?s.frontFace(s.CW):s.frontFace(s.CCW),O=j)}function Ut(j){j!==By?(Se(s.CULL_FACE),j!==K&&(j===yx?s.cullFace(s.BACK):j===Iy?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):qe(s.CULL_FACE),K=j}function Kt(j){j!==ae&&(B&&s.lineWidth(j),ae=j)}function at(j,Ye,ke){j?(Se(s.POLYGON_OFFSET_FILL),(le!==Ye||Te!==ke)&&(s.polygonOffset(Ye,ke),le=Ye,Te=ke)):qe(s.POLYGON_OFFSET_FILL)}function nn(j){j?Se(s.SCISSOR_TEST):qe(s.SCISSOR_TEST)}function pe(j){j===void 0&&(j=s.TEXTURE0+Me-1),Re!==j&&(s.activeTexture(j),Re=j)}function Ee(j,Ye,ke){ke===void 0&&(Re===null?ke=s.TEXTURE0+Me-1:ke=Re);let Xe=ce[ke];Xe===void 0&&(Xe={type:void 0,texture:void 0},ce[ke]=Xe),(Xe.type!==j||Xe.texture!==Ye)&&(Re!==ke&&(s.activeTexture(ke),Re=ke),s.bindTexture(j,Ye||me[j]),Xe.type=j,Xe.texture=Ye)}function P(){const j=ce[Re];j!==void 0&&j.type!==void 0&&(s.bindTexture(j.type,null),j.type=void 0,j.texture=void 0)}function w(){try{s.compressedTexImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function ne(){try{s.compressedTexImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function be(){try{s.texSubImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function De(){try{s.texSubImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function ee(){try{s.compressedTexSubImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function Ie(){try{s.compressedTexSubImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function Ge(){try{s.texStorage2D(...arguments)}catch(j){j("WebGLState:",j)}}function ht(){try{s.texStorage3D(...arguments)}catch(j){j("WebGLState:",j)}}function Be(){try{s.texImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function Ue(){try{s.texImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function Oe(j){we.equals(j)===!1&&(s.scissor(j.x,j.y,j.z,j.w),we.copy(j))}function tt(j){ze.equals(j)===!1&&(s.viewport(j.x,j.y,j.z,j.w),ze.copy(j))}function it(j,Ye){let ke=g.get(Ye);ke===void 0&&(ke=new WeakMap,g.set(Ye,ke));let Xe=ke.get(j);Xe===void 0&&(Xe=s.getUniformBlockIndex(Ye,j.name),ke.set(j,Xe))}function je(j,Ye){const Xe=g.get(Ye).get(j);_.get(Ye)!==Xe&&(s.uniformBlockBinding(Ye,Xe,j.__bindingPointIndex),_.set(Ye,Xe))}function vt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),p.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),b={},Re=null,ce={},S={},E=new WeakMap,A=[],U=null,L=!1,T=null,M=null,X=null,H=null,q=null,Q=null,V=null,k=new Zt(0,0,0),ue=0,F=!1,O=null,K=null,ae=null,le=null,Te=null,we.set(0,0,s.canvas.width,s.canvas.height),ze.set(0,0,s.canvas.width,s.canvas.height),f.reset(),p.reset(),m.reset()}return{buffers:{color:f,depth:p,stencil:m},enable:Se,disable:qe,bindFramebuffer:lt,drawBuffers:ft,useProgram:yt,setBlending:Ot,setMaterial:Y,setFlipSided:Et,setCullFace:Ut,setLineWidth:Kt,setPolygonOffset:at,setScissorTest:nn,activeTexture:pe,bindTexture:Ee,unbindTexture:P,compressedTexImage2D:w,compressedTexImage3D:ne,texImage2D:Be,texImage3D:Ue,updateUBOMapping:it,uniformBlockBinding:je,texStorage2D:Ge,texStorage3D:ht,texSubImage2D:be,texSubImage3D:De,compressedTexSubImage2D:ee,compressedTexSubImage3D:Ie,scissor:Oe,viewport:tt,reset:vt}}function X3(s,e,i,r,l,f,p){const m=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,_=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new Dt,b=new WeakMap;let S;const E=new WeakMap;let A=!1;try{A=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function U(P,w){return A?new OffscreenCanvas(P,w):ju("canvas")}function L(P,w,ne){let be=1;const De=Ee(P);if((De.width>ne||De.height>ne)&&(be=ne/Math.max(De.width,De.height)),be<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const ee=Math.floor(be*De.width),Ie=Math.floor(be*De.height);S===void 0&&(S=U(ee,Ie));const Ge=w?U(ee,Ie):S;return Ge.width=ee,Ge.height=Ie,Ge.getContext("2d").drawImage(P,0,0,ee,Ie),wt("WebGLRenderer: Texture has been resized from ("+De.width+"x"+De.height+") to ("+ee+"x"+Ie+")."),Ge}else return"data"in P&&wt("WebGLRenderer: Image in DataTexture is too big ("+De.width+"x"+De.height+")."),P;return P}function T(P){return P.generateMipmaps}function M(P){s.generateMipmap(P)}function X(P){return P.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?s.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function H(P,w,ne,be,De=!1){if(P!==null){if(s[P]!==void 0)return s[P];wt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let ee=w;if(w===s.RED&&(ne===s.FLOAT&&(ee=s.R32F),ne===s.HALF_FLOAT&&(ee=s.R16F),ne===s.UNSIGNED_BYTE&&(ee=s.R8)),w===s.RED_INTEGER&&(ne===s.UNSIGNED_BYTE&&(ee=s.R8UI),ne===s.UNSIGNED_SHORT&&(ee=s.R16UI),ne===s.UNSIGNED_INT&&(ee=s.R32UI),ne===s.BYTE&&(ee=s.R8I),ne===s.SHORT&&(ee=s.R16I),ne===s.INT&&(ee=s.R32I)),w===s.RG&&(ne===s.FLOAT&&(ee=s.RG32F),ne===s.HALF_FLOAT&&(ee=s.RG16F),ne===s.UNSIGNED_BYTE&&(ee=s.RG8)),w===s.RG_INTEGER&&(ne===s.UNSIGNED_BYTE&&(ee=s.RG8UI),ne===s.UNSIGNED_SHORT&&(ee=s.RG16UI),ne===s.UNSIGNED_INT&&(ee=s.RG32UI),ne===s.BYTE&&(ee=s.RG8I),ne===s.SHORT&&(ee=s.RG16I),ne===s.INT&&(ee=s.RG32I)),w===s.RGB_INTEGER&&(ne===s.UNSIGNED_BYTE&&(ee=s.RGB8UI),ne===s.UNSIGNED_SHORT&&(ee=s.RGB16UI),ne===s.UNSIGNED_INT&&(ee=s.RGB32UI),ne===s.BYTE&&(ee=s.RGB8I),ne===s.SHORT&&(ee=s.RGB16I),ne===s.INT&&(ee=s.RGB32I)),w===s.RGBA_INTEGER&&(ne===s.UNSIGNED_BYTE&&(ee=s.RGBA8UI),ne===s.UNSIGNED_SHORT&&(ee=s.RGBA16UI),ne===s.UNSIGNED_INT&&(ee=s.RGBA32UI),ne===s.BYTE&&(ee=s.RGBA8I),ne===s.SHORT&&(ee=s.RGBA16I),ne===s.INT&&(ee=s.RGBA32I)),w===s.RGB&&(ne===s.UNSIGNED_INT_5_9_9_9_REV&&(ee=s.RGB9_E5),ne===s.UNSIGNED_INT_10F_11F_11F_REV&&(ee=s.R11F_G11F_B10F)),w===s.RGBA){const Ie=De?qu:tn.getTransfer(be);ne===s.FLOAT&&(ee=s.RGBA32F),ne===s.HALF_FLOAT&&(ee=s.RGBA16F),ne===s.UNSIGNED_BYTE&&(ee=Ie===pn?s.SRGB8_ALPHA8:s.RGBA8),ne===s.UNSIGNED_SHORT_4_4_4_4&&(ee=s.RGBA4),ne===s.UNSIGNED_SHORT_5_5_5_1&&(ee=s.RGB5_A1)}return(ee===s.R16F||ee===s.R32F||ee===s.RG16F||ee===s.RG32F||ee===s.RGBA16F||ee===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function q(P,w){let ne;return P?w===null||w===Ss||w===Yl?ne=s.DEPTH24_STENCIL8:w===Qa?ne=s.DEPTH32F_STENCIL8:w===ql&&(ne=s.DEPTH24_STENCIL8,wt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):w===null||w===Ss||w===Yl?ne=s.DEPTH_COMPONENT24:w===Qa?ne=s.DEPTH_COMPONENT32F:w===ql&&(ne=s.DEPTH_COMPONENT16),ne}function Q(P,w){return T(P)===!0||P.isFramebufferTexture&&P.minFilter!==Ni&&P.minFilter!==Yi?Math.log2(Math.max(w.width,w.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?w.mipmaps.length:1}function V(P){const w=P.target;w.removeEventListener("dispose",V),ue(w),w.isVideoTexture&&b.delete(w)}function k(P){const w=P.target;w.removeEventListener("dispose",k),O(w)}function ue(P){const w=r.get(P);if(w.__webglInit===void 0)return;const ne=P.source,be=E.get(ne);if(be){const De=be[w.__cacheKey];De.usedTimes--,De.usedTimes===0&&F(P),Object.keys(be).length===0&&E.delete(ne)}r.remove(P)}function F(P){const w=r.get(P);s.deleteTexture(w.__webglTexture);const ne=P.source,be=E.get(ne);delete be[w.__cacheKey],p.memory.textures--}function O(P){const w=r.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),r.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let be=0;be<6;be++){if(Array.isArray(w.__webglFramebuffer[be]))for(let De=0;De<w.__webglFramebuffer[be].length;De++)s.deleteFramebuffer(w.__webglFramebuffer[be][De]);else s.deleteFramebuffer(w.__webglFramebuffer[be]);w.__webglDepthbuffer&&s.deleteRenderbuffer(w.__webglDepthbuffer[be])}else{if(Array.isArray(w.__webglFramebuffer))for(let be=0;be<w.__webglFramebuffer.length;be++)s.deleteFramebuffer(w.__webglFramebuffer[be]);else s.deleteFramebuffer(w.__webglFramebuffer);if(w.__webglDepthbuffer&&s.deleteRenderbuffer(w.__webglDepthbuffer),w.__webglMultisampledFramebuffer&&s.deleteFramebuffer(w.__webglMultisampledFramebuffer),w.__webglColorRenderbuffer)for(let be=0;be<w.__webglColorRenderbuffer.length;be++)w.__webglColorRenderbuffer[be]&&s.deleteRenderbuffer(w.__webglColorRenderbuffer[be]);w.__webglDepthRenderbuffer&&s.deleteRenderbuffer(w.__webglDepthRenderbuffer)}const ne=P.textures;for(let be=0,De=ne.length;be<De;be++){const ee=r.get(ne[be]);ee.__webglTexture&&(s.deleteTexture(ee.__webglTexture),p.memory.textures--),r.remove(ne[be])}r.remove(P)}let K=0;function ae(){K=0}function le(){const P=K;return P>=l.maxTextures&&wt("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+l.maxTextures),K+=1,P}function Te(P){const w=[];return w.push(P.wrapS),w.push(P.wrapT),w.push(P.wrapR||0),w.push(P.magFilter),w.push(P.minFilter),w.push(P.anisotropy),w.push(P.internalFormat),w.push(P.format),w.push(P.type),w.push(P.generateMipmaps),w.push(P.premultiplyAlpha),w.push(P.flipY),w.push(P.unpackAlignment),w.push(P.colorSpace),w.join()}function Me(P,w){const ne=r.get(P);if(P.isVideoTexture&&nn(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&ne.__version!==P.version){const be=P.image;if(be===null)wt("WebGLRenderer: Texture marked for update but no image data found.");else if(be.complete===!1)wt("WebGLRenderer: Texture marked for update but image is incomplete");else{me(ne,P,w);return}}else P.isExternalTexture&&(ne.__webglTexture=P.sourceTexture?P.sourceTexture:null);i.bindTexture(s.TEXTURE_2D,ne.__webglTexture,s.TEXTURE0+w)}function B(P,w){const ne=r.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&ne.__version!==P.version){me(ne,P,w);return}else P.isExternalTexture&&(ne.__webglTexture=P.sourceTexture?P.sourceTexture:null);i.bindTexture(s.TEXTURE_2D_ARRAY,ne.__webglTexture,s.TEXTURE0+w)}function $(P,w){const ne=r.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&ne.__version!==P.version){me(ne,P,w);return}i.bindTexture(s.TEXTURE_3D,ne.__webglTexture,s.TEXTURE0+w)}function te(P,w){const ne=r.get(P);if(P.version>0&&ne.__version!==P.version){Se(ne,P,w);return}i.bindTexture(s.TEXTURE_CUBE_MAP,ne.__webglTexture,s.TEXTURE0+w)}const Re={[xp]:s.REPEAT,[Ka]:s.CLAMP_TO_EDGE,[_p]:s.MIRRORED_REPEAT},ce={[Ni]:s.NEAREST,[pS]:s.NEAREST_MIPMAP_NEAREST,[gu]:s.NEAREST_MIPMAP_LINEAR,[Yi]:s.LINEAR,[Td]:s.LINEAR_MIPMAP_NEAREST,[ys]:s.LINEAR_MIPMAP_LINEAR},I={[_S]:s.NEVER,[ES]:s.ALWAYS,[vS]:s.LESS,[H_]:s.LEQUAL,[yS]:s.EQUAL,[MS]:s.GEQUAL,[SS]:s.GREATER,[bS]:s.NOTEQUAL};function re(P,w){if(w.type===Qa&&e.has("OES_texture_float_linear")===!1&&(w.magFilter===Yi||w.magFilter===Td||w.magFilter===gu||w.magFilter===ys||w.minFilter===Yi||w.minFilter===Td||w.minFilter===gu||w.minFilter===ys)&&wt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(P,s.TEXTURE_WRAP_S,Re[w.wrapS]),s.texParameteri(P,s.TEXTURE_WRAP_T,Re[w.wrapT]),(P===s.TEXTURE_3D||P===s.TEXTURE_2D_ARRAY)&&s.texParameteri(P,s.TEXTURE_WRAP_R,Re[w.wrapR]),s.texParameteri(P,s.TEXTURE_MAG_FILTER,ce[w.magFilter]),s.texParameteri(P,s.TEXTURE_MIN_FILTER,ce[w.minFilter]),w.compareFunction&&(s.texParameteri(P,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(P,s.TEXTURE_COMPARE_FUNC,I[w.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(w.magFilter===Ni||w.minFilter!==gu&&w.minFilter!==ys||w.type===Qa&&e.has("OES_texture_float_linear")===!1)return;if(w.anisotropy>1||r.get(w).__currentAnisotropy){const ne=e.get("EXT_texture_filter_anisotropic");s.texParameterf(P,ne.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(w.anisotropy,l.getMaxAnisotropy())),r.get(w).__currentAnisotropy=w.anisotropy}}}function we(P,w){let ne=!1;P.__webglInit===void 0&&(P.__webglInit=!0,w.addEventListener("dispose",V));const be=w.source;let De=E.get(be);De===void 0&&(De={},E.set(be,De));const ee=Te(w);if(ee!==P.__cacheKey){De[ee]===void 0&&(De[ee]={texture:s.createTexture(),usedTimes:0},p.memory.textures++,ne=!0),De[ee].usedTimes++;const Ie=De[P.__cacheKey];Ie!==void 0&&(De[P.__cacheKey].usedTimes--,Ie.usedTimes===0&&F(w)),P.__cacheKey=ee,P.__webglTexture=De[ee].texture}return ne}function ze(P,w,ne){return Math.floor(Math.floor(P/ne)/w)}function et(P,w,ne,be){const ee=P.updateRanges;if(ee.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,w.width,w.height,ne,be,w.data);else{ee.sort((Ue,Oe)=>Ue.start-Oe.start);let Ie=0;for(let Ue=1;Ue<ee.length;Ue++){const Oe=ee[Ie],tt=ee[Ue],it=Oe.start+Oe.count,je=ze(tt.start,w.width,4),vt=ze(Oe.start,w.width,4);tt.start<=it+1&&je===vt&&ze(tt.start+tt.count-1,w.width,4)===je?Oe.count=Math.max(Oe.count,tt.start+tt.count-Oe.start):(++Ie,ee[Ie]=tt)}ee.length=Ie+1;const Ge=s.getParameter(s.UNPACK_ROW_LENGTH),ht=s.getParameter(s.UNPACK_SKIP_PIXELS),Be=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,w.width);for(let Ue=0,Oe=ee.length;Ue<Oe;Ue++){const tt=ee[Ue],it=Math.floor(tt.start/4),je=Math.ceil(tt.count/4),vt=it%w.width,j=Math.floor(it/w.width),Ye=je,ke=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,vt),s.pixelStorei(s.UNPACK_SKIP_ROWS,j),i.texSubImage2D(s.TEXTURE_2D,0,vt,j,Ye,ke,ne,be,w.data)}P.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,Ge),s.pixelStorei(s.UNPACK_SKIP_PIXELS,ht),s.pixelStorei(s.UNPACK_SKIP_ROWS,Be)}}function me(P,w,ne){let be=s.TEXTURE_2D;(w.isDataArrayTexture||w.isCompressedArrayTexture)&&(be=s.TEXTURE_2D_ARRAY),w.isData3DTexture&&(be=s.TEXTURE_3D);const De=we(P,w),ee=w.source;i.bindTexture(be,P.__webglTexture,s.TEXTURE0+ne);const Ie=r.get(ee);if(ee.version!==Ie.__version||De===!0){i.activeTexture(s.TEXTURE0+ne);const Ge=tn.getPrimaries(tn.workingColorSpace),ht=w.colorSpace===Br?null:tn.getPrimaries(w.colorSpace),Be=w.colorSpace===Br||Ge===ht?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,w.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,w.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Be);let Ue=L(w.image,!1,l.maxTextureSize);Ue=pe(w,Ue);const Oe=f.convert(w.format,w.colorSpace),tt=f.convert(w.type);let it=H(w.internalFormat,Oe,tt,w.colorSpace,w.isVideoTexture);re(be,w);let je;const vt=w.mipmaps,j=w.isVideoTexture!==!0,Ye=Ie.__version===void 0||De===!0,ke=ee.dataReady,Xe=Q(w,Ue);if(w.isDepthTexture)it=q(w.format===Zl,w.type),Ye&&(j?i.texStorage2D(s.TEXTURE_2D,1,it,Ue.width,Ue.height):i.texImage2D(s.TEXTURE_2D,0,it,Ue.width,Ue.height,0,Oe,tt,null));else if(w.isDataTexture)if(vt.length>0){j&&Ye&&i.texStorage2D(s.TEXTURE_2D,Xe,it,vt[0].width,vt[0].height);for(let Pe=0,Le=vt.length;Pe<Le;Pe++)je=vt[Pe],j?ke&&i.texSubImage2D(s.TEXTURE_2D,Pe,0,0,je.width,je.height,Oe,tt,je.data):i.texImage2D(s.TEXTURE_2D,Pe,it,je.width,je.height,0,Oe,tt,je.data);w.generateMipmaps=!1}else j?(Ye&&i.texStorage2D(s.TEXTURE_2D,Xe,it,Ue.width,Ue.height),ke&&et(w,Ue,Oe,tt)):i.texImage2D(s.TEXTURE_2D,0,it,Ue.width,Ue.height,0,Oe,tt,Ue.data);else if(w.isCompressedTexture)if(w.isCompressedArrayTexture){j&&Ye&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Xe,it,vt[0].width,vt[0].height,Ue.depth);for(let Pe=0,Le=vt.length;Pe<Le;Pe++)if(je=vt[Pe],w.format!==sa)if(Oe!==null)if(j){if(ke)if(w.layerUpdates.size>0){const rt=t_(je.width,je.height,w.format,w.type);for(const Mt of w.layerUpdates){const st=je.data.subarray(Mt*rt/je.data.BYTES_PER_ELEMENT,(Mt+1)*rt/je.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Pe,0,0,Mt,je.width,je.height,1,Oe,st)}w.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Pe,0,0,0,je.width,je.height,Ue.depth,Oe,je.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Pe,it,je.width,je.height,Ue.depth,0,je.data,0,0);else wt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else j?ke&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,Pe,0,0,0,je.width,je.height,Ue.depth,Oe,tt,je.data):i.texImage3D(s.TEXTURE_2D_ARRAY,Pe,it,je.width,je.height,Ue.depth,0,Oe,tt,je.data)}else{j&&Ye&&i.texStorage2D(s.TEXTURE_2D,Xe,it,vt[0].width,vt[0].height);for(let Pe=0,Le=vt.length;Pe<Le;Pe++)je=vt[Pe],w.format!==sa?Oe!==null?j?ke&&i.compressedTexSubImage2D(s.TEXTURE_2D,Pe,0,0,je.width,je.height,Oe,je.data):i.compressedTexImage2D(s.TEXTURE_2D,Pe,it,je.width,je.height,0,je.data):wt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):j?ke&&i.texSubImage2D(s.TEXTURE_2D,Pe,0,0,je.width,je.height,Oe,tt,je.data):i.texImage2D(s.TEXTURE_2D,Pe,it,je.width,je.height,0,Oe,tt,je.data)}else if(w.isDataArrayTexture)if(j){if(Ye&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Xe,it,Ue.width,Ue.height,Ue.depth),ke)if(w.layerUpdates.size>0){const Pe=t_(Ue.width,Ue.height,w.format,w.type);for(const Le of w.layerUpdates){const rt=Ue.data.subarray(Le*Pe/Ue.data.BYTES_PER_ELEMENT,(Le+1)*Pe/Ue.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Le,Ue.width,Ue.height,1,Oe,tt,rt)}w.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Ue.width,Ue.height,Ue.depth,Oe,tt,Ue.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,it,Ue.width,Ue.height,Ue.depth,0,Oe,tt,Ue.data);else if(w.isData3DTexture)j?(Ye&&i.texStorage3D(s.TEXTURE_3D,Xe,it,Ue.width,Ue.height,Ue.depth),ke&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Ue.width,Ue.height,Ue.depth,Oe,tt,Ue.data)):i.texImage3D(s.TEXTURE_3D,0,it,Ue.width,Ue.height,Ue.depth,0,Oe,tt,Ue.data);else if(w.isFramebufferTexture){if(Ye)if(j)i.texStorage2D(s.TEXTURE_2D,Xe,it,Ue.width,Ue.height);else{let Pe=Ue.width,Le=Ue.height;for(let rt=0;rt<Xe;rt++)i.texImage2D(s.TEXTURE_2D,rt,it,Pe,Le,0,Oe,tt,null),Pe>>=1,Le>>=1}}else if(vt.length>0){if(j&&Ye){const Pe=Ee(vt[0]);i.texStorage2D(s.TEXTURE_2D,Xe,it,Pe.width,Pe.height)}for(let Pe=0,Le=vt.length;Pe<Le;Pe++)je=vt[Pe],j?ke&&i.texSubImage2D(s.TEXTURE_2D,Pe,0,0,Oe,tt,je):i.texImage2D(s.TEXTURE_2D,Pe,it,Oe,tt,je);w.generateMipmaps=!1}else if(j){if(Ye){const Pe=Ee(Ue);i.texStorage2D(s.TEXTURE_2D,Xe,it,Pe.width,Pe.height)}ke&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Oe,tt,Ue)}else i.texImage2D(s.TEXTURE_2D,0,it,Oe,tt,Ue);T(w)&&M(be),Ie.__version=ee.version,w.onUpdate&&w.onUpdate(w)}P.__version=w.version}function Se(P,w,ne){if(w.image.length!==6)return;const be=we(P,w),De=w.source;i.bindTexture(s.TEXTURE_CUBE_MAP,P.__webglTexture,s.TEXTURE0+ne);const ee=r.get(De);if(De.version!==ee.__version||be===!0){i.activeTexture(s.TEXTURE0+ne);const Ie=tn.getPrimaries(tn.workingColorSpace),Ge=w.colorSpace===Br?null:tn.getPrimaries(w.colorSpace),ht=w.colorSpace===Br||Ie===Ge?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,w.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,w.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ht);const Be=w.isCompressedTexture||w.image[0].isCompressedTexture,Ue=w.image[0]&&w.image[0].isDataTexture,Oe=[];for(let Le=0;Le<6;Le++)!Be&&!Ue?Oe[Le]=L(w.image[Le],!0,l.maxCubemapSize):Oe[Le]=Ue?w.image[Le].image:w.image[Le],Oe[Le]=pe(w,Oe[Le]);const tt=Oe[0],it=f.convert(w.format,w.colorSpace),je=f.convert(w.type),vt=H(w.internalFormat,it,je,w.colorSpace),j=w.isVideoTexture!==!0,Ye=ee.__version===void 0||be===!0,ke=De.dataReady;let Xe=Q(w,tt);re(s.TEXTURE_CUBE_MAP,w);let Pe;if(Be){j&&Ye&&i.texStorage2D(s.TEXTURE_CUBE_MAP,Xe,vt,tt.width,tt.height);for(let Le=0;Le<6;Le++){Pe=Oe[Le].mipmaps;for(let rt=0;rt<Pe.length;rt++){const Mt=Pe[rt];w.format!==sa?it!==null?j?ke&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt,0,0,Mt.width,Mt.height,it,Mt.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt,vt,Mt.width,Mt.height,0,Mt.data):wt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):j?ke&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt,0,0,Mt.width,Mt.height,it,je,Mt.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt,vt,Mt.width,Mt.height,0,it,je,Mt.data)}}}else{if(Pe=w.mipmaps,j&&Ye){Pe.length>0&&Xe++;const Le=Ee(Oe[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,Xe,vt,Le.width,Le.height)}for(let Le=0;Le<6;Le++)if(Ue){j?ke&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0,0,0,Oe[Le].width,Oe[Le].height,it,je,Oe[Le].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0,vt,Oe[Le].width,Oe[Le].height,0,it,je,Oe[Le].data);for(let rt=0;rt<Pe.length;rt++){const st=Pe[rt].image[Le].image;j?ke&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt+1,0,0,st.width,st.height,it,je,st.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt+1,vt,st.width,st.height,0,it,je,st.data)}}else{j?ke&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0,0,0,it,je,Oe[Le]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0,vt,it,je,Oe[Le]);for(let rt=0;rt<Pe.length;rt++){const Mt=Pe[rt];j?ke&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt+1,0,0,it,je,Mt.image[Le]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,rt+1,vt,it,je,Mt.image[Le])}}}T(w)&&M(s.TEXTURE_CUBE_MAP),ee.__version=De.version,w.onUpdate&&w.onUpdate(w)}P.__version=w.version}function qe(P,w,ne,be,De,ee){const Ie=f.convert(ne.format,ne.colorSpace),Ge=f.convert(ne.type),ht=H(ne.internalFormat,Ie,Ge,ne.colorSpace),Be=r.get(w),Ue=r.get(ne);if(Ue.__renderTarget=w,!Be.__hasExternalTextures){const Oe=Math.max(1,w.width>>ee),tt=Math.max(1,w.height>>ee);De===s.TEXTURE_3D||De===s.TEXTURE_2D_ARRAY?i.texImage3D(De,ee,ht,Oe,tt,w.depth,0,Ie,Ge,null):i.texImage2D(De,ee,ht,Oe,tt,0,Ie,Ge,null)}i.bindFramebuffer(s.FRAMEBUFFER,P),at(w)?m.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,be,De,Ue.__webglTexture,0,Kt(w)):(De===s.TEXTURE_2D||De>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&De<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,be,De,Ue.__webglTexture,ee),i.bindFramebuffer(s.FRAMEBUFFER,null)}function lt(P,w,ne){if(s.bindRenderbuffer(s.RENDERBUFFER,P),w.depthBuffer){const be=w.depthTexture,De=be&&be.isDepthTexture?be.type:null,ee=q(w.stencilBuffer,De),Ie=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ge=Kt(w);at(w)?m.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ge,ee,w.width,w.height):ne?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ge,ee,w.width,w.height):s.renderbufferStorage(s.RENDERBUFFER,ee,w.width,w.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Ie,s.RENDERBUFFER,P)}else{const be=w.textures;for(let De=0;De<be.length;De++){const ee=be[De],Ie=f.convert(ee.format,ee.colorSpace),Ge=f.convert(ee.type),ht=H(ee.internalFormat,Ie,Ge,ee.colorSpace),Be=Kt(w);ne&&at(w)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Be,ht,w.width,w.height):at(w)?m.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Be,ht,w.width,w.height):s.renderbufferStorage(s.RENDERBUFFER,ht,w.width,w.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ft(P,w){if(w&&w.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,P),!(w.depthTexture&&w.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const be=r.get(w.depthTexture);be.__renderTarget=w,(!be.__webglTexture||w.depthTexture.image.width!==w.width||w.depthTexture.image.height!==w.height)&&(w.depthTexture.image.width=w.width,w.depthTexture.image.height=w.height,w.depthTexture.needsUpdate=!0),Me(w.depthTexture,0);const De=be.__webglTexture,ee=Kt(w);if(w.depthTexture.format===jl)at(w)?m.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,De,0,ee):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,De,0);else if(w.depthTexture.format===Zl)at(w)?m.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,De,0,ee):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,De,0);else throw new Error("Unknown depthTexture format")}function yt(P){const w=r.get(P),ne=P.isWebGLCubeRenderTarget===!0;if(w.__boundDepthTexture!==P.depthTexture){const be=P.depthTexture;if(w.__depthDisposeCallback&&w.__depthDisposeCallback(),be){const De=()=>{delete w.__boundDepthTexture,delete w.__depthDisposeCallback,be.removeEventListener("dispose",De)};be.addEventListener("dispose",De),w.__depthDisposeCallback=De}w.__boundDepthTexture=be}if(P.depthTexture&&!w.__autoAllocateDepthBuffer){if(ne)throw new Error("target.depthTexture not supported in Cube render targets");const be=P.texture.mipmaps;be&&be.length>0?ft(w.__webglFramebuffer[0],P):ft(w.__webglFramebuffer,P)}else if(ne){w.__webglDepthbuffer=[];for(let be=0;be<6;be++)if(i.bindFramebuffer(s.FRAMEBUFFER,w.__webglFramebuffer[be]),w.__webglDepthbuffer[be]===void 0)w.__webglDepthbuffer[be]=s.createRenderbuffer(),lt(w.__webglDepthbuffer[be],P,!1);else{const De=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ee=w.__webglDepthbuffer[be];s.bindRenderbuffer(s.RENDERBUFFER,ee),s.framebufferRenderbuffer(s.FRAMEBUFFER,De,s.RENDERBUFFER,ee)}}else{const be=P.texture.mipmaps;if(be&&be.length>0?i.bindFramebuffer(s.FRAMEBUFFER,w.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,w.__webglFramebuffer),w.__webglDepthbuffer===void 0)w.__webglDepthbuffer=s.createRenderbuffer(),lt(w.__webglDepthbuffer,P,!1);else{const De=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ee=w.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ee),s.framebufferRenderbuffer(s.FRAMEBUFFER,De,s.RENDERBUFFER,ee)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function rn(P,w,ne){const be=r.get(P);w!==void 0&&qe(be.__webglFramebuffer,P,P.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),ne!==void 0&&yt(P)}function Tt(P){const w=P.texture,ne=r.get(P),be=r.get(w);P.addEventListener("dispose",k);const De=P.textures,ee=P.isWebGLCubeRenderTarget===!0,Ie=De.length>1;if(Ie||(be.__webglTexture===void 0&&(be.__webglTexture=s.createTexture()),be.__version=w.version,p.memory.textures++),ee){ne.__webglFramebuffer=[];for(let Ge=0;Ge<6;Ge++)if(w.mipmaps&&w.mipmaps.length>0){ne.__webglFramebuffer[Ge]=[];for(let ht=0;ht<w.mipmaps.length;ht++)ne.__webglFramebuffer[Ge][ht]=s.createFramebuffer()}else ne.__webglFramebuffer[Ge]=s.createFramebuffer()}else{if(w.mipmaps&&w.mipmaps.length>0){ne.__webglFramebuffer=[];for(let Ge=0;Ge<w.mipmaps.length;Ge++)ne.__webglFramebuffer[Ge]=s.createFramebuffer()}else ne.__webglFramebuffer=s.createFramebuffer();if(Ie)for(let Ge=0,ht=De.length;Ge<ht;Ge++){const Be=r.get(De[Ge]);Be.__webglTexture===void 0&&(Be.__webglTexture=s.createTexture(),p.memory.textures++)}if(P.samples>0&&at(P)===!1){ne.__webglMultisampledFramebuffer=s.createFramebuffer(),ne.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,ne.__webglMultisampledFramebuffer);for(let Ge=0;Ge<De.length;Ge++){const ht=De[Ge];ne.__webglColorRenderbuffer[Ge]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,ne.__webglColorRenderbuffer[Ge]);const Be=f.convert(ht.format,ht.colorSpace),Ue=f.convert(ht.type),Oe=H(ht.internalFormat,Be,Ue,ht.colorSpace,P.isXRRenderTarget===!0),tt=Kt(P);s.renderbufferStorageMultisample(s.RENDERBUFFER,tt,Oe,P.width,P.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ge,s.RENDERBUFFER,ne.__webglColorRenderbuffer[Ge])}s.bindRenderbuffer(s.RENDERBUFFER,null),P.depthBuffer&&(ne.__webglDepthRenderbuffer=s.createRenderbuffer(),lt(ne.__webglDepthRenderbuffer,P,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(ee){i.bindTexture(s.TEXTURE_CUBE_MAP,be.__webglTexture),re(s.TEXTURE_CUBE_MAP,w);for(let Ge=0;Ge<6;Ge++)if(w.mipmaps&&w.mipmaps.length>0)for(let ht=0;ht<w.mipmaps.length;ht++)qe(ne.__webglFramebuffer[Ge][ht],P,w,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ge,ht);else qe(ne.__webglFramebuffer[Ge],P,w,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ge,0);T(w)&&M(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Ie){for(let Ge=0,ht=De.length;Ge<ht;Ge++){const Be=De[Ge],Ue=r.get(Be);let Oe=s.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Oe=P.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Oe,Ue.__webglTexture),re(Oe,Be),qe(ne.__webglFramebuffer,P,Be,s.COLOR_ATTACHMENT0+Ge,Oe,0),T(Be)&&M(Oe)}i.unbindTexture()}else{let Ge=s.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Ge=P.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Ge,be.__webglTexture),re(Ge,w),w.mipmaps&&w.mipmaps.length>0)for(let ht=0;ht<w.mipmaps.length;ht++)qe(ne.__webglFramebuffer[ht],P,w,s.COLOR_ATTACHMENT0,Ge,ht);else qe(ne.__webglFramebuffer,P,w,s.COLOR_ATTACHMENT0,Ge,0);T(w)&&M(Ge),i.unbindTexture()}P.depthBuffer&&yt(P)}function Ot(P){const w=P.textures;for(let ne=0,be=w.length;ne<be;ne++){const De=w[ne];if(T(De)){const ee=X(P),Ie=r.get(De).__webglTexture;i.bindTexture(ee,Ie),M(ee),i.unbindTexture()}}}const Y=[],Et=[];function Ut(P){if(P.samples>0){if(at(P)===!1){const w=P.textures,ne=P.width,be=P.height;let De=s.COLOR_BUFFER_BIT;const ee=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ie=r.get(P),Ge=w.length>1;if(Ge)for(let Be=0;Be<w.length;Be++)i.bindFramebuffer(s.FRAMEBUFFER,Ie.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Be,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,Ie.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Be,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,Ie.__webglMultisampledFramebuffer);const ht=P.texture.mipmaps;ht&&ht.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ie.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ie.__webglFramebuffer);for(let Be=0;Be<w.length;Be++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(De|=s.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(De|=s.STENCIL_BUFFER_BIT)),Ge){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Ie.__webglColorRenderbuffer[Be]);const Ue=r.get(w[Be]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Ue,0)}s.blitFramebuffer(0,0,ne,be,0,0,ne,be,De,s.NEAREST),_===!0&&(Y.length=0,Et.length=0,Y.push(s.COLOR_ATTACHMENT0+Be),P.depthBuffer&&P.resolveDepthBuffer===!1&&(Y.push(ee),Et.push(ee),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Et)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Y))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Ge)for(let Be=0;Be<w.length;Be++){i.bindFramebuffer(s.FRAMEBUFFER,Ie.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Be,s.RENDERBUFFER,Ie.__webglColorRenderbuffer[Be]);const Ue=r.get(w[Be]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,Ie.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Be,s.TEXTURE_2D,Ue,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ie.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&_){const w=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[w])}}}function Kt(P){return Math.min(l.maxSamples,P.samples)}function at(P){const w=r.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&w.__useRenderToTexture!==!1}function nn(P){const w=p.render.frame;b.get(P)!==w&&(b.set(P,w),P.update())}function pe(P,w){const ne=P.colorSpace,be=P.format,De=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||ne!==Po&&ne!==Br&&(tn.getTransfer(ne)===pn?(be!==sa||De!==va)&&wt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Cn("WebGLTextures: Unsupported texture color space:",ne)),w}function Ee(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(g.width=P.naturalWidth||P.width,g.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(g.width=P.displayWidth,g.height=P.displayHeight):(g.width=P.width,g.height=P.height),g}this.allocateTextureUnit=le,this.resetTextureUnits=ae,this.setTexture2D=Me,this.setTexture2DArray=B,this.setTexture3D=$,this.setTextureCube=te,this.rebindTextures=rn,this.setupRenderTarget=Tt,this.updateRenderTargetMipmap=Ot,this.updateMultisampleRenderTarget=Ut,this.setupDepthRenderbuffer=yt,this.setupFrameBufferTexture=qe,this.useMultisampledRTT=at}function W3(s,e){function i(r,l=Br){let f;const p=tn.getTransfer(l);if(r===va)return s.UNSIGNED_BYTE;if(r===$p)return s.UNSIGNED_SHORT_4_4_4_4;if(r===em)return s.UNSIGNED_SHORT_5_5_5_1;if(r===O_)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===P_)return s.UNSIGNED_INT_10F_11F_11F_REV;if(r===L_)return s.BYTE;if(r===N_)return s.SHORT;if(r===ql)return s.UNSIGNED_SHORT;if(r===Jp)return s.INT;if(r===Ss)return s.UNSIGNED_INT;if(r===Qa)return s.FLOAT;if(r===zo)return s.HALF_FLOAT;if(r===F_)return s.ALPHA;if(r===z_)return s.RGB;if(r===sa)return s.RGBA;if(r===jl)return s.DEPTH_COMPONENT;if(r===Zl)return s.DEPTH_STENCIL;if(r===B_)return s.RED;if(r===tm)return s.RED_INTEGER;if(r===nm)return s.RG;if(r===im)return s.RG_INTEGER;if(r===am)return s.RGBA_INTEGER;if(r===Iu||r===Hu||r===Vu||r===Gu)if(p===pn)if(f=e.get("WEBGL_compressed_texture_s3tc_srgb"),f!==null){if(r===Iu)return f.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Hu)return f.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Vu)return f.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Gu)return f.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(f=e.get("WEBGL_compressed_texture_s3tc"),f!==null){if(r===Iu)return f.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Hu)return f.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Vu)return f.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Gu)return f.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===vp||r===yp||r===Sp||r===bp)if(f=e.get("WEBGL_compressed_texture_pvrtc"),f!==null){if(r===vp)return f.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===yp)return f.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Sp)return f.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===bp)return f.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Mp||r===Ep||r===Tp)if(f=e.get("WEBGL_compressed_texture_etc"),f!==null){if(r===Mp||r===Ep)return p===pn?f.COMPRESSED_SRGB8_ETC2:f.COMPRESSED_RGB8_ETC2;if(r===Tp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:f.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Ap||r===wp||r===Rp||r===Cp||r===Dp||r===Up||r===Lp||r===Np||r===Op||r===Pp||r===Fp||r===zp||r===Bp||r===Ip)if(f=e.get("WEBGL_compressed_texture_astc"),f!==null){if(r===Ap)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:f.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===wp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:f.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Rp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:f.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Cp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:f.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Dp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:f.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Up)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:f.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Lp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:f.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Np)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:f.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Op)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:f.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Pp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:f.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Fp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:f.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===zp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:f.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Bp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:f.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Ip)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:f.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Hp||r===Vp||r===Gp)if(f=e.get("EXT_texture_compression_bptc"),f!==null){if(r===Hp)return p===pn?f.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:f.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Vp)return f.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Gp)return f.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===kp||r===Xp||r===Wp||r===qp)if(f=e.get("EXT_texture_compression_rgtc"),f!==null){if(r===kp)return f.COMPRESSED_RED_RGTC1_EXT;if(r===Xp)return f.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Wp)return f.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===qp)return f.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Yl?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const q3=`
void main() {
...
`)}return d=d.replace(/\s+$/,""),d}function fc(c,d,x){var y=uc(c);if(!d||x<=0)return j(y)+1;var C=Ln(y,d,x);return C+1}var rr=()=>2147483648,Qr=()=>rr(),Cf=c=>{var d=F.buffer,x=(c-d.byteLength+65535)/65536|0;try{return F.grow(x),ce(),1}catch{}},Is=c=>{var d=le.length;c>>>=0;var x=rr();if(c>x)return!1;for(var y=1;y<=4;y*=2){var C=d*(1+.2/y);C=Math.min(C,c+100663296);var z=Math.min(x,rt(Math.max(c,C),65536)),G=Cf(z);if(G)return!0}return!1},Hs={},hc=()=>U||"./this.program",Ea=()=>{if(!Ea.strings){var c=(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",d={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:c,_:hc()};for(var x in Hs)Hs[x]===void 0?delete d[x]:d[x]=Hs[x];var y=[];for(var x in d)y.push(`${x}=${d[x]}`);Ea.strings=y}return Ea.strings},el=(c,d)=>{for(var x=0;x<c.length;++x)ae[d++]=c.charCodeAt(x);ae[d]=0},dc=(c,d)=>{var x=0;return Ea().forEach((y,C)=>{var z=d+x;$[c+C*4>>2]=z,el(y,z),x+=y.length+1}),0},pc=(c,d)=>{var x=Ea();$[c>>2]=x.length;var y=0;return x.forEach(C=>y+=C.length+1),$[d>>2]=y,0},mc=c=>{L(c,new Ge(c))},Df=(c,d)=>{mc(c)},Uf=Df;function Lf(c){try{var d=Ht.getStreamFromFD(c);return R.close(d),0}catch(x){if(typeof R>"u"||x.name!=="ErrnoError")throw x;return x.errno}}var Nf=(c,d,x,y)=>{for(var C=0,z=0;z<x;z++){var G=$[d>>2],Z=$[d+4>>2];d+=8;var ve=R.read(c,ae,G,Z,y);if(ve<0)return-1;if(C+=ve,ve<Z)break}return C};function Of(c,d,x,y){try{var C=Ht.getStreamFromFD(c),z=Nf(C,d,x);return $[y>>2]=z,0}catch(G){if(typeof R>"u"||G.name!=="ErrnoError")throw G;return G.errno}}function fi(c,d,x,y,C){var z=zs(d,x);try{if(isNaN(z))return 61;var G=Ht.getStreamFromFD(c);return R.llseek(G,z,y),Ie=[G.position>>>0,(ee=G.position,+Math.abs(ee)>=1?ee>0?+Math.floor(ee/4294967296)>>>0:~~+Math.ceil((ee-+(~~ee>>>0))/4294967296)>>>0:0)],B[C>>2]=Ie[0],B[C+4>>2]=Ie[1],G.getdents&&z===0&&y===0&&(G.getdents=null),0}catch(Z){if(typeof R>"u"||Z.name!=="ErrnoError")throw Z;return Z.errno}}var Jr=(c,d,x,y)=>{for(var C=0,z=0;z<x;z++){var G=$[d>>2],Z=$[d+4>>2];d+=8;var ve=R.write(c,ae,G,Z,y);if(ve<0)return-1;if(C+=ve,ve<Z)break}return C};function gc(c,d,x,y){try{var C=Ht.getStreamFromFD(c),z=Jr(C,d,x);return $[y>>2]=z,0}catch(G){if(typeof R>"u"||G.name!=="ErrnoError")throw G;return G.errno}}R.createPreloadedFile=Gr,R.staticInit(),oe(),_t=p.BindingError=class extends Error{constructor(d){super(d),this.name="BindingError"}},Rt=p.InternalError=class extends Error{constructor(d){super(d),this.name="InternalError"}},ji(),ir=p.UnboundTypeError=jo(Error,"UnboundTypeError");var xc={M:ui,N:En,h:tr,I:Vo,Q:Go,F:As,G:ba,j:Xr,B:la,H:N,C:ie,A:_e,w:fe,V:sn,U:Pn,n:Fi,f:ec,b:Ls,a:tc,m:Ma,i:nc,W:of,J:cf,x:ff,L:hf,e:df,q:mf,T:Pi,u:gf,p:_f,k:vf,Y:yf,X:Sf,r:bf,Z:Mf,o:Ef,c:Tf,d:$o,t:lc,s:cc,O:ar,K:wf,R:fc,z:Qr,y:Is,D:dc,E:pc,S:Uf,g:Lf,P:Of,v:fi,l:gc},Fn=De(),tl=c=>(tl=Fn.aa)(c),$r=c=>($r=Fn.ca)(c),$i=c=>($i=Fn.da)(c),Ta=c=>(Ta=Fn.ea)(c),Vs=(c,d)=>(Vs=Fn.fa)(c,d),sr=()=>(sr=Fn.ga)();p.dynCall_viijii=(c,d,x,y,C,z,G)=>(p.dynCall_viijii=Fn.ha)(c,d,x,y,C,z,G),p.dynCall_viiiiji=(c,d,x,y,C,z,G,Z)=>(p.dynCall_viiiiji=Fn.ia)(c,d,x,y,C,z,G,Z),p.dynCall_jiji=(c,d,x,y,C)=>(p.dynCall_jiji=Fn.ja)(c,d,x,y,C),p.dynCall_iiiiij=(c,d,x,y,C,z,G)=>(p.dynCall_iiiiij=Fn.ka)(c,d,x,y,C,z,G),p.dynCall_iiiiijj=(c,d,x,y,C,z,G,Z,ve)=>(p.dynCall_iiiiijj=Fn.la)(c,d,x,y,C,z,G,Z,ve),p.dynCall_iiiiiijj=(c,d,x,y,C,z,G,Z,ve,Fe)=>(p.dynCall_iiiiiijj=Fn.ma)(c,d,x,y,C,z,G,Z,ve,Fe);var or,nl;rn=function c(){or||ua(),or||(rn=c)};function ua(){if(yt>0||!nl&&(nl=1,et(),yt>0))return;function c(){or||(or=1,p.calledRun=1,!O&&(me(),m(p),p.onRuntimeInitialized?.(),Se()))}p.setStatus?(p.setStatus("Running..."),setTimeout(()=>{setTimeout(()=>p.setStatus(""),1),c()},1)):c()}if(p.preInit)for(typeof p.preInit=="function"&&(p.preInit=[p.preInit]);p.preInit.length>0;)p.preInit.pop()();return ua(),f=g,f})})();s.exports=i})(ip)),ip.exports}var vT=_T();const yT=Ay(vT),ST="/step-3d-viewer/assets/occt-import-js-BhHfLpto.wasm";let rp=null;const bT={linearUnit:"millimeter",linearDeflectionType:"bounding_box_ratio",linearDeflection:.003,angularDeflection:.4};function R_(){return rp||(rp=yT({locateFile:()=>ST})),rp}const MT="Drag a .step/.stp file into the viewer area, or use the control panel.",ET="Loading OpenCascade engine...",TT=s=>s.includes("\\X")?s.replace(/\\X([0-9A-F])\\([^\\]*)\\X0\\/gi,(e,i,r)=>{const l=i.toUpperCase();let f=4;l==="4"?f=8:l==="1"&&(f=2);const p=[];for(let m=0;m<r.length;m+=f){const _=r.slice(m,m+f);if(!_)continue;const g=parseInt(_,16);Number.isNaN(g)||p.push(String.fromCodePoint(g))}return p.join("")}):s,ov=s=>{if(!s)return"";const i=TT(s).replace(/"/g,"").trim();return i||""},AT=s=>{const e=new Map;if(!s)return e;const i=(r,l)=>{const f=ov(r.name),p=f?[...l,f]:l;Array.isArray(r.meshes)&&r.meshes.forEach(m=>{if(typeof m=="number"&&!e.has(m)){const _=p[p.length-1]||f;_&&e.set(m,_)}}),r.children?.forEach(m=>i(m,p))};return i(s,[]),e};function wT(){const s=Ze.useRef(null),e=Ze.useRef(null),i=Ze.useRef(null),r=Ze.useRef(null),l=Ze.useRef(null),f=Ze.useRef(null),p=Ze.useRef(0),m=Ze.useRef(null),_=Ze.useRef(new hb),g=Ze.useRef(new Dt),b=Ze.useRef(null),S=Ze.useRef(new Map),E=Ze.useRef(null),A=-1e-4,[U,L]=Ze.useState(ET),[T,M]=Ze.useState(null),[X,H]=Ze.useState(!1),[q,Q]=Ze.useState(!1),[V,k]=Ze.useState(!1),[ue,F]=Ze.useState(!1),[O,K]=Ze.useState("#ffad0d"),[ae,le]=Ze.useState(null),[Te,Me]=Ze.useState(null),[B,$]=Ze.useState([]),te=Ze.useCallback(pe=>{const Ee=b.current;if(Ee&&Ee.material instanceof Fr){const P=Ee.userData.baseEmissiveHex;typeof P=="number"&&Ee.material.emissive.setHex(P)}pe&&pe.material instanceof Fr?(pe.userData.baseEmissiveHex===void 0&&(pe.userData.baseEmissiveHex=pe.material.emissive.getHex()),pe.material.emissive.setHex(2964090),b.current=pe,le(pe.name||"Unnamed"),Me(pe.uuid),typeof pe.userData.paintColorHex=="string"&&K(pe.userData.paintColorHex)):(b.current=null,le(null),Me(null))},[K]),Re=Ze.useCallback(pe=>{const Ee=m.current;Ee&&Ee.traverse(P=>{P instanceof Li&&pe(P)})},[]),ce=Ze.useCallback((pe,Ee)=>{const P=e.current,w=r.current,ne=m.current;if(!P||!w||!ne)return null;const be=P.domElement.getBoundingClientRect();g.current.x=(pe-be.left)/be.width*2-1,g.current.y=-((Ee-be.top)/be.height)*2+1,_.current.setFromCamera(g.current,w);const ee=_.current.intersectObjects(ne.children,!0).find(Ie=>Ie.object instanceof Li&&Ie.object.visible&&!Ie.object.userData?.extinguished);return ee?ee.object:null},[]),I=Ze.useCallback((pe,Ee)=>{const P=ce(pe,Ee);return te(P),!!P},[ce,te]),re=Ze.useCallback(()=>{const pe=m.current;if(!pe){$([]);return}const Ee=[];pe.traverse(P=>{P instanceof Li&&Ee.push({id:P.uuid,label:P.name||`Body ${Ee.length+1}`,visible:P.visible})}),$(Ee)},[]),we=Ze.useCallback(pe=>{const Ee=S.current.get(pe);return te(Ee??null),!!Ee},[te]);Ze.useEffect(()=>{let pe=!0;return R_().then(()=>{pe&&(F(!0),L(MT))}).catch(Ee=>{console.error(Ee),pe&&(M("Failed to load the OpenCascade engine"),L("Please refresh the page"))}),()=>{pe=!1}},[]),Ze.useEffect(()=>{if(!s.current)return;const pe=new $S;pe.background=null,i.current=pe;const Ee=new tT({antialias:!0,alpha:!0});Ee.setClearColor(0,0),Ee.setPixelRatio(window.devicePixelRatio),e.current=Ee;const P=new qi(45,1,.1,2e3);P.position.set(4,4,4),r.current=P;const w=new iT(P,Ee.domElement);w.enableDamping=!0,w.dampingFactor=.08,l.current=w;const ne=new ub(16777215,.6),be=new Qx(16777215,.85);be.position.set(5,10,4);const De=new Qx(16777215,.45);De.position.set(-4,-6,-5),pe.add(ne,be,De);const ee=new db(60,60,3093826,1842985);ee.position.y=A,(Array.isArray(ee.material)?ee.material:[ee.material]).forEach(Oe=>{Oe.transparent=!0,Oe.opacity=.4,Oe.depthWrite=!1}),ee.visible=!0,E.current=ee,pe.add(ee);const Ge=s.current;Ge.appendChild(Ee.domElement);const ht=Oe=>{if(Oe.button===2)return;const tt=ce(Oe.clientX,Oe.clientY);te(tt)},Be=()=>{if(!Ge||!r.current)return;const{clientWidth:Oe,clientHeight:tt}=Ge;Ee.setSize(Oe,tt);const it=r.current;it.aspect=Oe/Math.max(tt,1),it.updateProjectionMatrix()};Be(),window.addEventListener("resize",Be),Ee.domElement.addEventListener("pointerdown",ht);const Ue=()=>{w.update(),Ee.render(pe,P),f.current=requestAnimationFrame(Ue)};return Ue(),()=>{window.removeEventListener("resize",Be),Ee.domElement.removeEventListener("pointerdown",ht),f.current&&cancelAnimationFrame(f.current),w.dispose(),Ee.dispose(),E.current&&i.current?.children.includes(E.current)&&i.current.remove(E.current),E.current=null,Ge.contains(Ee.domElement)&&Ge.removeChild(Ee.domElement)}},[te,ce]);const ze=Ze.useCallback(()=>{!i.current||!m.current||(i.current.remove(m.current),m.current.traverse(pe=>{pe instanceof Li&&(pe.geometry.dispose(),Array.isArray(pe.material)?pe.material.forEach(Ee=>Ee.dispose()):pe.material.dispose())}),m.current=null,S.current.clear(),$([]),E.current&&(E.current.visible=!0,E.current.position.y=A),te(null))},[te]),et=Ze.useCallback(pe=>{const Ee=r.current,P=l.current;if(!Ee||!P)return;pe.updateMatrixWorld(!0);const w=new Bo().setFromObject(pe),ne=w.getSize(new xe),be=w.getCenter(new xe);pe.position.sub(be);const De=Math.max(ne.x,ne.y,ne.z),ee=De===0?5:De*1.6,Ie=new xe(1.5,1,1.2).normalize();Ee.position.copy(Ie.multiplyScalar(ee)),Ee.near=Math.max(ee/200,.01),Ee.far=ee*20,Ee.updateProjectionMatrix(),P.target.set(0,0,0),P.update()},[]),me=Ze.useCallback(pe=>{if(!i.current)return;ze();const Ee=new Xl;S.current.clear();const P=AT(pe.root);pe.meshes.forEach((w,ne)=>{const be=new oa,De=w.attributes.position?.array??[];be.setAttribute("position",new Oi(De,3));const ee=w.attributes.normal?.array;ee?.length?be.setAttribute("normal",new Oi(ee,3)):be.computeVertexNormals(),w.index?.array?.length&&be.setIndex(w.index.array);const Ie=w.color??w.brep_faces?.find(je=>je.color)?.color??[.82,.86,.92],Ge=new Zt(Ie[0],Ie[1],Ie[2]),ht=new Fr({color:Ge,metalness:.15,roughness:.35,side:ga}),Be=`#${Ge.getHexString()}`,Ue=new Li(be,ht),Oe=`Body ${ne+1}`,it=P.get(ne)||ov(w.name)||Oe;Ue.name=it,Ue.userData.originalColorHex=Be,Ue.userData.paintColorHex=Be,Ee.add(Ue),S.current.set(Ue.uuid,Ue)}),i.current.add(Ee),m.current=Ee,k(!0),et(Ee),E.current&&(E.current.visible=!1),te(null),re()},[ze,et,te,re]),Se=Ze.useCallback(()=>{const pe=b.current;return!pe||!(pe.material instanceof Fr)?!1:(pe.material.color.set(O),pe.material.needsUpdate=!0,pe.userData.paintColorHex=O,!0)},[O]),qe=Ze.useCallback(pe=>{const Ee=b.current;return!Ee||!(Ee.material instanceof Fr)?!1:(Ee.material.color.set(pe),Ee.material.needsUpdate=!0,Ee.userData.paintColorHex=pe,K(pe),!0)},[]),lt=Ze.useCallback(()=>{const pe=b.current;if(!pe||!(pe.material instanceof Fr))return!1;const Ee=pe.userData.originalColorHex||"#d5dde8";return pe.material.color.set(Ee),pe.material.needsUpdate=!0,pe.userData.paintColorHex=Ee,!0},[]),ft=Ze.useCallback(()=>{const pe=[];return Re(Ee=>{if(!(Ee.material instanceof Fr))return;const P=typeof Ee.userData.paintColorHex=="string"?Ee.userData.paintColorHex:`#${Ee.material.color.getHexString()}`;pe.push({name:Ee.name||"",color:P,visible:Ee.visible})}),pe.length?{version:1,generatedAt:new Date().toISOString(),meshes:pe}:null},[Re]),yt=Ze.useCallback(pe=>{if(!pe||pe.version!==1)return!1;const Ee=new Map,P=[];return Re(w=>{P.push(w);const ne=w.name||"__noname__";Ee.has(ne)||Ee.set(ne,[]),Ee.get(ne).push(w)}),P.length?(pe.meshes.forEach((w,ne)=>{const be=w.name||"__noname__";let ee=Ee.get(be)?.shift();if(ee||(ee=P[ne]),!ee||!(ee.material instanceof Fr))return;const Ie=w.color||"#d5dde8";ee.material.color.set(Ie),ee.material.needsUpdate=!0,ee.userData.paintColorHex=Ie,ee.visible=w.visible!==!1}),(!b.current||!b.current.visible)&&te(null),re(),!0):!1},[Re,te,re]),rn=Ze.useCallback(()=>{const pe=b.current;return pe?(pe.visible=!1,pe.userData.extinguished=!0,te(null),re(),!0):!1},[re,te]),Tt=Ze.useCallback(async(pe,Ee)=>{H(!0),M(null),L(`Importing ${Ee}...`);try{const P=await R_(),w=new Uint8Array(pe),ne=P.ReadStepFile(w,bT);if(!ne?.success||!ne.meshes?.length)throw new Error("OCCT returned an empty result");me(ne),L(`Done: ${Ee} (${ne.meshes.length} objects)`)}catch(P){console.error(P),k(!1),E.current&&(E.current.visible=!0,E.current.position.y=A);const w=P instanceof Error?P.message:"Unknown error importing the file";M(w),L("Import failed")}finally{H(!1)}},[me]),Ot=Ze.useCallback(async pe=>{const Ee=await pe.arrayBuffer();await Tt(Ee,pe.name)},[Tt]),Y=Ze.useCallback(async pe=>{const Ee=pe.target.files?.[0];Ee&&await Ot(Ee),pe.target.value=""},[Ot]),Et=Ze.useCallback(async(pe,Ee="sample",P)=>{L(`Loading ${Ee}...`),M(null);try{const w=await fetch(pe);if(!w.ok)throw new Error("Failed to fetch sample");const ne=await w.arrayBuffer();await Tt(ne,P??`${Ee}.step`)}catch(w){console.error(w),M(w instanceof Error?w.message:"Sample load error"),L("Try another file")}},[Tt]),Ut=Ze.useCallback(async pe=>{pe.preventDefault(),p.current=0,Q(!1);const Ee=pe.dataTransfer.files?.[0];Ee&&await Ot(Ee)},[Ot]),Kt=Ze.useCallback(pe=>{pe.preventDefault(),pe.dataTransfer.dropEffect="copy"},[]),at=Ze.useCallback(pe=>{pe.preventDefault(),p.current+=1,Q(!0)},[]),nn=Ze.useCallback(pe=>{pe.preventDefault(),p.current=Math.max(p.current-1,0),p.current===0&&Q(!1)},[]);return{canvasHostRef:s,status:U,error:T,isLoading:X,occtReady:ue,hasModel:V,isDragActive:q,controlsDisabled:!ue||X,handleDragEnter:at,handleDragLeave:nn,handleDragOver:Kt,handleDrop:Ut,handleFileInput:Y,loadSample:Et,selectionColor:O,setSelectionColor:K,selectedMeshName:ae,selectedMeshId:Te,applyColorToSelection:Se,applyColorToSelectionWithValue:qe,resetSelectionColor:lt,extinguishSelection:rn,selectMeshAtScreenPosition:I,selectMeshById:we,serializeSceneState:ft,applySceneState:yt,meshTree:B}}function RT({canvasRef:s,hasModel:e,isDragActive:i,isLoading:r,isPanelOpen:l,panelId:f,onContextMenu:p,onTouchStart:m,onTouchMove:_,onTouchEnd:g,onDragEnter:b,onDragLeave:S,onDragOver:E,onDrop:A,onTogglePanel:U,children:L}){return We.jsxs("section",{className:`viewer ${i?"viewer--active":""}`,onContextMenu:p,onTouchStart:m,onTouchMove:_,onTouchEnd:g,onDragEnter:b,onDragOver:E,onDragLeave:S,onDrop:A,children:[We.jsx("div",{ref:s,className:"viewer__canvas"}),!e&&We.jsxs("div",{className:"viewer__placeholder",children:[We.jsx("p",{children:"Drag a .step/.stp file here."}),We.jsx("p",{className:"muted",children:"Or use the control panel."})]}),i&&We.jsx("div",{className:"viewer__drop-hint",children:"Release to import the file"}),r&&We.jsxs("div",{className:"viewer__loading","aria-live":"polite",children:[We.jsx("div",{className:"viewer__loading-spinner"}),We.jsx("p",{children:"Importing model..."})]}),!l&&We.jsx("button",{type:"button",className:"panel-toggle","aria-expanded":!1,"aria-controls":f,onClick:U,children:"Menu"}),L]})}function CT({samples:s,disabled:e,onSelect:i}){return We.jsxs("section",{className:"sample-library","aria-label":"Sample library",children:[We.jsxs("div",{className:"sample-library__header",children:[We.jsx("p",{className:"section-label",children:"Sample Library"}),We.jsx("span",{className:"sample-library__count",children:s.length})]}),We.jsxs("div",{className:"sample-library__list",children:[s.length===0&&We.jsxs("span",{className:"sample-library__empty",children:["Add .step/.stp files to the ",We.jsx("code",{children:"public/models"})," folder"]}),s.map(r=>We.jsxs("button",{type:"button",className:"sample-card",onClick:()=>i(r),disabled:e,title:`Open ${r.fileName}`,children:[We.jsx("span",{className:"sample-card__label",children:r.label}),We.jsx("span",{className:"sample-card__meta",children:r.fileName})]},r.fileName))]})]})}function DT({nodes:s,selectedId:e,onSelect:i,disabled:r}){return We.jsxs("div",{className:"model-tree",children:[We.jsxs("div",{className:"model-tree__header",children:[We.jsx("p",{className:"section-label",children:"Model Tree"}),We.jsx("span",{className:"model-tree__count",children:s.length})]}),We.jsxs("div",{className:"model-tree__list",role:"tree",children:[s.map(l=>We.jsxs("button",{type:"button",role:"treeitem",className:"model-tree__item","data-selected":l.id===e,onClick:()=>i(l.id),disabled:r,"aria-selected":l.id===e,children:[We.jsx("span",{className:"model-tree__item-label",children:l.label}),!l.visible&&We.jsx("span",{className:"model-tree__item-muted",children:"hidden"})]},l.id)),!s.length&&We.jsx("p",{className:"model-tree__empty",children:"Load a model to see the body list."})]})]})}function UT({className:s,ariaHidden:e,error:i,isLoading:r,controlsDisabled:l,onFileChange:f,onHidePanel:p,selectionColor:m,onSelectionColorChange:_,selectedMeshName:g,onApplyColor:b,onResetColor:S,colorPalette:E,onSelectPaletteColor:A,onAddPaletteColor:U,onRemovePaletteColor:L,canAddPaletteColor:T,onSaveSceneState:M,onLoadSceneState:X,sceneStateDisabled:H,samples:q,onSampleSelect:Q,modelTree:V,selectedMeshId:k,onSelectTreeNode:ue,children:F}){const O=Ze.useRef(null),K=ae=>{const le=ae.target.files?.[0];le&&X(le),ae.target.value=""};return We.jsxs("aside",{id:"control-panel",className:s,"aria-hidden":e,children:[We.jsx("button",{type:"button",className:"panel-close",onClick:p,"aria-label":"Close panel",children:We.jsx("span",{"aria-hidden":"true",children:"←"})}),We.jsxs("div",{className:"panel__header",children:[We.jsx("p",{className:"eyebrow",children:"WebAssembly + three.js"}),We.jsx("h1",{children:"STEP 3D Viewer"})]}),We.jsxs("div",{className:"controls",children:[We.jsxs("label",{className:"file-input","data-disabled":l,children:[We.jsx("input",{type:"file",accept:".step,.stp,.STEP,.STP,model/step,application/step",onChange:f,disabled:l}),We.jsx("span",{children:"Choose .step file"})]}),r&&We.jsx("div",{className:"loader","aria-live":"polite"})]}),We.jsx(CT,{samples:q,disabled:l,onSelect:Q}),We.jsx(DT,{nodes:V,selectedId:k,onSelect:ue,disabled:r}),i&&We.jsx("div",{className:"error-banner",children:i}),We.jsxs("div",{className:"color-controls",children:[We.jsxs("div",{className:"color-input",children:[We.jsx("label",{htmlFor:"color-picker",children:"Color"}),We.jsx("input",{id:"color-picker",type:"color",value:m,onChange:_,"aria-label":"Select highlight color"})]}),We.jsxs("div",{className:"selection-info",children:[We.jsx("span",{className:"selection-label",children:g?`Selected: ${g}`:"Nothing selected"}),We.jsxs("div",{className:"selection-actions",children:[We.jsx("button",{type:"button",className:"primary",onClick:b,disabled:!g,children:"Apply color"}),We.jsx("button",{type:"button",className:"ghost",onClick:S,disabled:!g,children:"Reset"})]})]})]}),We.jsxs("div",{className:"color-palette",children:[We.jsxs("div",{className:"color-palette__header",children:[We.jsx("p",{className:"section-label",children:"Palette"}),We.jsx("button",{type:"button",className:"ghost",onClick:U,disabled:!T,children:"Add color"})]}),We.jsxs("div",{className:"color-palette__list",children:[E.map(ae=>We.jsxs("button",{type:"button",className:"color-swatch","aria-label":`Color ${ae}`,onClick:()=>A(ae),style:{background:ae},children:[We.jsx("span",{className:"color-swatch__value",children:ae.toUpperCase()}),We.jsx("span",{className:"color-swatch__remove",role:"button","aria-label":"Remove color from palette",onClick:le=>{le.stopPropagation(),L(ae)},children:"×"})]},ae)),E.length===0&&We.jsx("p",{className:"color-palette__empty",children:"No colors yet — add the current color."})]})]}),We.jsxs("div",{className:"scene-state-actions",children:[We.jsx("p",{className:"section-label",children:"Scene state"}),We.jsxs("div",{className:"scene-state-actions__buttons",children:[We.jsx("button",{type:"button",className:"ghost",onClick:M,disabled:H,children:"Save"}),We.jsx("button",{type:"button",className:"ghost",onClick:()=>O.current?.click(),disabled:H,children:"Load"})]}),We.jsx("input",{ref:O,type:"file",accept:"application/json",onChange:K,style:{display:"none"}})]}),F]})}function LT({x:s,y:e,onExtinguish:i,onChangeColor:r,currentColor:l,palette:f,onPaletteColorSelect:p,canApplyColor:m}){const _=g=>{g.stopPropagation()};return We.jsxs("div",{className:"context-menu",style:{top:`${e}px`,left:`${s}px`},role:"menu",onClick:_,onPointerDown:_,children:[We.jsxs("div",{className:"context-menu__group",children:[We.jsx("p",{className:"context-menu__label",children:"Highlight color"}),We.jsx("input",{type:"color","aria-label":"Select highlighted body color",value:l,onChange:g=>r(g.target.value)})]}),f.length>0&&We.jsxs("div",{className:"context-menu__palette",children:[We.jsx("p",{className:"context-menu__label",children:"Palette"}),We.jsx("div",{className:"context-menu__swatches",children:f.map(g=>We.jsx("button",{type:"button",className:"context-menu__swatch",style:{background:g},onClick:()=>p(g),disabled:!m,"aria-label":`Apply color ${g}`,children:g.toUpperCase()},g))})]}),We.jsx("button",{type:"button",role:"menuitem",onClick:i,children:"Hide selected body"})]})}function NT({theme:s,onToggle:e}){const i=s==="light"?"dark":"light";return We.jsxs("button",{type:"button",className:"theme-toggle",onClick:e,"aria-label":`Switch to ${i} theme`,children:[We.jsx("span",{className:"theme-toggle__icon","aria-hidden":"true",children:s==="light"?"☾":"☀︎"}),s==="light"?"Dark":"Light"]})}const OT=[{fileName:"ins100.stp",url:"/step-3d-viewer/models/ins100.stp"},{fileName:"masterpact-lv864962.stp",url:"/step-3d-viewer/models/masterpact-lv864962.stp"},{fileName:"nsx-lv432956.stp",url:"/step-3d-viewer/models/nsx-lv432956.stp"}],PT=s=>s.replace(/\.(step|stp)$/i,"").replace(/[-_]+/g," "),FT=OT.map(({fileName:s,url:e})=>({label:PT(s),fileName:s,url:e})).sort((s,e)=>s.label.localeCompare(e.label,"ru")),Wu=s=>{if(typeof s!="string")return s;const e=s.trim().toLowerCase();return e.startsWith("#")?/^#[0-9a-f]{8}$/.test(e)?`#${e.slice(1,7)}`:/^#[0-9a-f]{6}$/.test(e)?e:/^#[0-9a-f]{4}$/.test(e)?`#${e[1]}${e[1]}${e[2]}${e[2]}${e[3]}${e[3]}`:/^#[0-9a-f]{3}$/.test(e)?`#${e[1]}${e[1]}${e[2]}${e[2]}${e[3]}${e[3]}`:e:e},zT=["#ff920dff","#4c6dffff","#8bc34aff","#ff0000ff"],BT=zT.map(s=>Wu(s)),lv="step-viewer-theme",IT=()=>{if(typeof window>"u")return"dark";const s=window.localStorage?.getItem(lv);return s==="dark"||s==="light"?s:window.matchMedia?.("(prefers-color-scheme: light)")?.matches?"light":"dark"};function HT(){const s=wT(),{selectMeshAtScreenPosition:e,selectedMeshName:i,serializeSceneState:r,applySceneState:l,hasModel:f}=s,[p,m]=Ze.useState(!1),[_,g]=Ze.useState(!1),[b,S]=Ze.useState(null),E=Ze.useRef(null),A=Ze.useRef(null),[U,L]=Ze.useState(BT),[T,M]=Ze.useState(()=>IT()),X=Ze.useCallback(()=>{M(ce=>ce==="dark"?"light":"dark")},[]);Ze.useEffect(()=>{typeof window>"u"||window.localStorage?.setItem(lv,T)},[T]),Ze.useEffect(()=>{const ce=window.matchMedia("(max-width: 768px)"),I=we=>{g(we),we&&m(!1)};I(ce.matches);const re=we=>{I(we.matches),we.matches&&m(!1)};return ce.addEventListener?ce.addEventListener("change",re):ce.addListener(re),()=>{ce.removeEventListener?ce.removeEventListener("change",re):ce.removeListener(re)}},[]);const H=Ze.useMemo(()=>["control-panel",_?"control-panel--mobile":"",p?"control-panel--open":"control-panel--collapsed"].filter(Boolean).join(" "),[_,p]),q="control-panel",Q=Ze.useMemo(()=>Wu(s.selectionColor),[s.selectionColor]),V=Ze.useMemo(()=>!U.includes(Q),[U,Q]),k=Ze.useCallback(()=>{const ce=r();if(!ce){alert("No model available to save.");return}const I=new Blob([JSON.stringify(ce,null,2)],{type:"application/json"}),re=URL.createObjectURL(I),we=document.createElement("a");we.href=re,we.download=`step-viewer-state-${new Date().toISOString().replace(/[:.]/g,"-")}.json`,we.click(),URL.revokeObjectURL(re)},[r]),ue=Ze.useCallback(async ce=>{try{const I=await ce.text(),re=JSON.parse(I);l(re)||alert("Failed to apply saved scene state.")}catch(I){console.error(I),alert("Failed to read the scene state file.")}},[l]),F=Ze.useCallback(ce=>{s.setSelectionColor(Wu(ce))},[s]),O=Ze.useCallback(()=>{L(ce=>ce.includes(Q)?ce:[...ce,Q])},[Q]),K=Ze.useCallback(ce=>{L(I=>I.filter(re=>re!==ce))},[]),ae=Ze.useCallback(ce=>{const I=Wu(ce);s.applyColorToSelectionWithValue(I),S(null)},[s]),le=Ze.useCallback(()=>{E.current!==null&&(window.clearTimeout(E.current),E.current=null)},[]),Te=Ze.useCallback((ce,I)=>!e(ce,I)&&!i?(S(null),!1):(S({x:ce,y:I}),!0),[e,i]),Me=Ze.useCallback(ce=>{ce.preventDefault(),ce.stopPropagation(),Te(ce.clientX,ce.clientY)},[Te]),B=Ze.useCallback(ce=>{if(ce.touches.length!==1){le();return}const I=ce.touches[0];A.current={x:I.clientX,y:I.clientY},le(),E.current=window.setTimeout(()=>{const re=A.current;re&&(Te(re.x,re.y),le())},550)},[le,Te]),$=Ze.useCallback(ce=>{if(!A.current)return;const I=ce.touches[0],re=I.clientX-A.current.x,we=I.clientY-A.current.y;Math.hypot(re,we)>15&&le()},[le]),te=Ze.useCallback(()=>{le(),A.current=null},[le]);Ze.useEffect(()=>{if(!b)return;const ce=re=>{re.button!==0&&re.pointerType!=="touch"||S(null)},I=()=>S(null);return window.addEventListener("pointerdown",ce),window.addEventListener("resize",I),()=>{window.removeEventListener("pointerdown",ce),window.removeEventListener("resize",I)}},[b]),Ze.useEffect(()=>()=>{le()},[le]),Ze.useEffect(()=>{i||S(null)},[i]);const Re=()=>{s.extinguishSelection(),S(null)};return We.jsx("div",{className:"app","data-panel-open":p,"data-mobile-layout":_,"data-theme":T,children:We.jsxs(RT,{canvasRef:s.canvasHostRef,hasModel:s.hasModel,isDragActive:s.isDragActive,isLoading:s.isLoading,isPanelOpen:p,panelId:q,onContextMenu:Me,onTouchStart:B,onTouchMove:$,onTouchEnd:te,onDragEnter:s.handleDragEnter,onDragLeave:s.handleDragLeave,onDragOver:s.handleDragOver,onDrop:s.handleDrop,onTogglePanel:()=>m(!0),children:[We.jsx(UT,{className:H,ariaHidden:!p,error:s.error,isLoading:s.isLoading,controlsDisabled:s.controlsDisabled,onFileChange:s.handleFileInput,onHidePanel:()=>m(!1),selectionColor:s.selectionColor,onSelectionColorChange:ce=>s.setSelectionColor(ce.target.value),selectedMeshName:s.selectedMeshName,onApplyColor:s.applyColorToSelection,onResetColor:s.resetSelectionColor,colorPalette:U,onSelectPaletteColor:F,onAddPaletteColor:O,onRemovePaletteColor:K,canAddPaletteColor:V,onSaveSceneState:k,onLoadSceneState:ue,sceneStateDisabled:!f,samples:FT,onSampleSelect:ce=>s.loadSample(ce.url,ce.label,ce.fileName),modelTree:s.meshTree,selectedMeshId:s.selectedMeshId,onSelectTreeNode:ce=>s.selectMeshById(ce)}),We.jsx(NT,{theme:T,onToggle:X}),b&&We.jsx(LT,{x:b.x,y:b.y,onExtinguish:Re,onChangeColor:ce=>s.applyColorToSelectionWithValue(ce),currentColor:s.selectionColor,palette:U,onPaletteColorSelect:ae,canApplyColor:!!s.selectedMeshName})]})})}zy.createRoot(document.getElementById("root")).render(We.jsx(Ze.StrictMode,{children:We.jsx(HT,{})}));"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/step-3d-viewer/sw.js").catch(e=>{console.error("Service worker registration failed:",e)})});
