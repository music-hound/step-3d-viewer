...
`)}function o3(o,e){let i;switch(e){case aS:i="Linear";break;case rS:i="Reinhard";break;case sS:i="Cineon";break;case oS:i="ACESFilmic";break;case cS:i="AgX";break;case uS:i="Neutral";break;case lS:i="Custom";break;default:Rt("WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const zu=new _e;function l3(){an.getLuminanceCoefficients(zu);const o=zu.x.toFixed(4),e=zu.y.toFixed(4),i=zu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
}`;function B3(o,e,i){let r=new sm;const l=new Ut,f=new Ut,p=new Dn,m=new ib({depthPacking:dS}),x=new ab,_={},S=i.maxTextureSize,b={[Hr]:Mi,[Mi]:Hr,[_a]:_a},E=new er({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ut},radius:{value:4}},vertexShader:F3,fragmentShader:z3}),A=E.clone();A.defines.HORIZONTAL_PASS=1;const U=new oa;U.setAttribute("position",new xa(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const N=new sa(U,E),T=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Rx;let M=this.type;this.render=function(V,k,he){if(T.enabled===!1||T.autoUpdate===!1&&T.needsUpdate===!1||V.length===0)return;const P=o.getRenderTarget(),O=o.getActiveCubeFace(),J=o.getActiveMipmapLevel(),se=o.state;se.setBlending(Ja),se.buffers.depth.getReversed()===!0?se.buffers.color.setClear(0,0,0,0):se.buffers.color.setClear(1,1,1,1),se.buffers.depth.setTest(!0),se.setScissorTest(!1);const ue=M!==Za&&this.type===Za,Me=M===Za&&this.type!==Za;for(let Se=0,z=V.length;Se<z;Se++){const $=V[Se],ie=$.shadow;if(ie===void 0){Rt("WebGLShadowMap:",$,"has no shadow.");continue}if(ie.autoUpdate===!1&&ie.needsUpdate===!1)continue;l.copy(ie.mapSize);const Te=ie.getFrameExtents();if(l.multiply(Te),f.copy(ie.mapSize),(l.x>S||l.y>S)&&(l.x>S&&(f.x=Math.floor(S/Te.x),l.x=f.x*Te.x,ie.mapSize.x=f.x),l.y>S&&(f.y=Math.floor(S/Te.y),l.y=f.y*Te.y,ie.mapSize.y=f.y)),ie.map===null||ue===!0||Me===!0){const H=this.type!==Za?{minFilter:Li,magFilter:Li}:{};ie.map!==null&&ie.map.dispose(),ie.map=new bs(l.x,l.y,H),ie.map.texture.name=$.name+".shadowMap",ie.camera.updateProjectionMatrix()}o.setRenderTarget(ie.map),o.clear();const Ce=ie.getViewportCount();for(let H=0;H<Ce;H++){const me=ie.getViewport(H);p.set(f.x*me.x,f.y*me.y,f.x*me.z,f.y*me.w),se.viewport(p),ie.updateMatrices($,H),r=ie.getFrustum(),Y(k,he,ie.camera,$,this.type)}ie.isPointLightShadow!==!0&&this.type===Za&&X(ie,he),ie.needsUpdate=!1}M=this.type,T.needsUpdate=!1,o.setRenderTarget(P,O,J)};function X(V,k){const he=e.update(N);E.defines.VSM_SAMPLES!==V.blurSamples&&(E.defines.VSM_SAMPLES=V.blurSamples,A.defines.VSM_SAMPLES=V.blurSamples,E.needsUpdate=!0,A.needsUpdate=!0),V.mapPass===null&&(V.mapPass=new bs(l.x,l.y)),E.uniforms.shadow_pass.value=V.map.texture,E.uniforms.resolution.value=V.mapSize,E.uniforms.radius.value=V.radius,o.setRenderTarget(V.mapPass),o.clear(),o.renderBufferDirect(k,null,he,E,N,null),A.uniforms.shadow_pass.value=V.mapPass.texture,A.uniforms.resolution.value=V.mapSize,A.uniforms.radius.value=V.radius,o.setRenderTarget(V.map),o.clear(),o.renderBufferDirect(k,null,he,A,N,null)}function I(V,k,he,P){let O=null;const J=he.isPointLight===!0?V.customDistanceMaterial:V.customDepthMaterial;if(J!==void 0)O=J;else if(O=he.isPointLight===!0?x:m,o.localClippingEnabled&&k.clipShadows===!0&&Array.isArray(k.clippingPlanes)&&k.clippingPlanes.length!==0||k.displacementMap&&k.displacementScale!==0||k.alphaMap&&k.alphaTest>0||k.map&&k.alphaTest>0||k.alphaToCoverage===!0){const se=O.uuid,ue=k.uuid;let Me=_[se];Me===void 0&&(Me={},_[se]=Me);let Se=Me[ue];Se===void 0&&(Se=O.clone(),Me[ue]=Se,k.addEventListener("dispose",ee)),O=Se}if(O.visible=k.visible,O.wireframe=k.wireframe,P===Za?O.side=k.shadowSide!==null?k.shadowSide:k.side:O.side=k.shadowSide!==null?k.shadowSide:b[k.side],O.alphaMap=k.alphaMap,O.alphaTest=k.alphaToCoverage===!0?.5:k.alphaTest,O.map=k.map,O.clipShadows=k.clipShadows,O.clippingPlanes=k.clippingPlanes,O.clipIntersection=k.clipIntersection,O.displacementMap=k.displacementMap,O.displacementScale=k.displacementScale,O.displacementBias=k.displacementBias,O.wireframeLinewidth=k.wireframeLinewidth,O.linewidth=k.linewidth,he.isPointLight===!0&&O.isMeshDistanceMaterial===!0){const se=o.properties.get(O);se.light=he}return O}function Y(V,k,he,P,O){if(V.visible===!1)return;if(V.layers.test(k.layers)&&(V.isMesh||V.isLine||V.isPoints)&&(V.castShadow||V.receiveShadow&&O===Za)&&(!V.frustumCulled||r.intersectsObject(V))){V.modelViewMatrix.multiplyMatrices(he.matrixWorldInverse,V.matrixWorld);const ue=e.update(V),Me=V.material;if(Array.isArray(Me)){const Se=ue.groups;for(let z=0,$=Se.length;z<$;z++){const ie=Se[z],Te=Me[ie.materialIndex];if(Te&&Te.visible){const Ce=I(V,Te,P,O);V.onBeforeShadow(o,V,k,he,ue,Ce,ie),o.renderBufferDirect(he,null,ue,Ce,V,ie),V.onAfterShadow(o,V,k,he,ue,Ce,ie)}}}else if(Me.visible){const Se=I(V,Me,P,O);V.onBeforeShadow(o,V,k,he,ue,Se,null),o.renderBufferDirect(he,null,ue,Se,V,null),V.onAfterShadow(o,V,k,he,ue,Se,null)}}const se=V.children;for(let ue=0,Me=se.length;ue<Me;ue++)Y(se[ue],k,he,P,O)}function ee(V){V.target.removeEventListener("dispose",ee);for(const he in _){const P=_[he],O=V.target.uuid;O in P&&(P[O].dispose(),delete P[O])}}}const I3={[op]:lp,[cp]:hp,[up]:dp,[Lo]:fp,[lp]:op,[hp]:cp,[dp]:up,[fp]:Lo};function H3(o,e){function i(){let j=!1;const Xe=new Dn;let Ve=null;const Ge=new Dn(0,0,0,0);return{setMask:function(Ue){Ve!==Ue&&!j&&(o.colorMask(Ue,Ue,Ue,Ue),Ve=Ue)},setLocked:function(Ue){j=Ue},setClear:function(Ue,we,nt,Mt,it){it===!0&&(Ue*=Mt,we*=Mt,nt*=Mt),Xe.set(Ue,we,nt,Mt),Ge.equals(Xe)===!1&&(o.clearColor(Ue,we,nt,Mt),Ge.copy(Xe))},reset:function(){j=!1,Ve=null,Ge.set(-1,0,0,0)}}}function r(){let j=!1,Xe=!1,Ve=null,Ge=null,Ue=null;return{setReversed:function(we){if(Xe!==we){const nt=e.get("EXT_clip_control");we?nt.clipControlEXT(nt.LOWER_LEFT_EXT,nt.ZERO_TO_ONE_EXT):nt.clipControlEXT(nt.LOWER_LEFT_EXT,nt.NEGATIVE_ONE_TO_ONE_EXT),Xe=we;const Mt=Ue;Ue=null,this.setClear(Mt)}},getReversed:function(){return Xe},setTest:function(we){we?Q(o.DEPTH_TEST):ye(o.DEPTH_TEST)},setMask:function(we){Ve!==we&&!j&&(o.depthMask(we),Ve=we)},setFunc:function(we){if(Xe&&(we=I3[we]),Ge!==we){switch(we){case op:o.depthFunc(o.NEVER);break;case lp:o.depthFunc(o.ALWAYS);break;case cp:o.depthFunc(o.LESS);break;case Lo:o.depthFunc(o.LEQUAL);break;case up:o.depthFunc(o.EQUAL);break;case fp:o.depthFunc(o.GEQUAL);break;case hp:o.depthFunc(o.GREATER);break;case dp:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Ge=we}},setLocked:function(we){j=we},setClear:function(we){Ue!==we&&(Xe&&(we=1-we),o.clearDepth(we),Ue=we)},reset:function(){j=!1,Ve=null,Ge=null,Ue=null,Xe=!1}}}function l(){let j=!1,Xe=null,Ve=null,Ge=null,Ue=null,we=null,nt=null,Mt=null,it=null;return{setTest:function($t){j||($t?Q(o.STENCIL_TEST):ye(o.STENCIL_TEST))},setMask:function($t){Xe!==$t&&!j&&(o.stencilMask($t),Xe=$t)},setFunc:function($t,Yn,li){(Ve!==$t||Ge!==Yn||Ue!==li)&&(o.stencilFunc($t,Yn,li),Ve=$t,Ge=Yn,Ue=li)},setOp:function($t,Yn,li){(we!==$t||nt!==Yn||Mt!==li)&&(o.stencilOp($t,Yn,li),we=$t,nt=Yn,Mt=li)},setLocked:function($t){j=$t},setClear:function($t){it!==$t&&(o.clearStencil($t),it=$t)},reset:function(){j=!1,Xe=null,Ve=null,Ge=null,Ue=null,we=null,nt=null,Mt=null,it=null}}}const f=new i,p=new r,m=new l,x=new WeakMap,_=new WeakMap;let S={},b={},E=new WeakMap,A=[],U=null,N=!1,T=null,M=null,X=null,I=null,Y=null,ee=null,V=null,k=new Kt(0,0,0),he=0,P=!1,O=null,J=null,se=null,ue=null,Me=null;const Se=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,$=0;const ie=o.getParameter(o.VERSION);ie.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(ie)[1]),z=$>=1):ie.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(ie)[1]),z=$>=2);let Te=null,Ce={};const H=o.getParameter(o.SCISSOR_BOX),me=o.getParameter(o.VIEWPORT),De=new Dn().fromArray(H),Fe=new Dn().fromArray(me);function $e(j,Xe,Ve,Ge){const Ue=new Uint8Array(4),we=o.createTexture();o.bindTexture(j,we),o.texParameteri(j,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(j,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let nt=0;nt<Ve;nt++)j===o.TEXTURE_3D||j===o.TEXTURE_2D_ARRAY?o.texImage3D(Xe,0,o.RGBA,1,1,Ge,0,o.RGBA,o.UNSIGNED_BYTE,Ue):o.texImage2D(Xe+nt,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Ue);return we}const de={};de[o.TEXTURE_2D]=$e(o.TEXTURE_2D,o.TEXTURE_2D,1),de[o.TEXTURE_CUBE_MAP]=$e(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[o.TEXTURE_2D_ARRAY]=$e(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),de[o.TEXTURE_3D]=$e(o.TEXTURE_3D,o.TEXTURE_3D,1,1),f.setClear(0,0,0,1),p.setClear(1),m.setClear(0),Q(o.DEPTH_TEST),p.setFunc(Lo),gt(!1),Tt(vg),Q(o.CULL_FACE),At(Ja);function Q(j){S[j]!==!0&&(o.enable(j),S[j]=!0)}function ye(j){S[j]!==!1&&(o.disable(j),S[j]=!1)}function Ie(j,Xe){return b[j]!==Xe?(o.bindFramebuffer(j,Xe),b[j]=Xe,j===o.DRAW_FRAMEBUFFER&&(b[o.FRAMEBUFFER]=Xe),j===o.FRAMEBUFFER&&(b[o.DRAW_FRAMEBUFFER]=Xe),!0):!1}function ke(j,Xe){let Ve=A,Ge=!1;if(j){Ve=E.get(Xe),Ve===void 0&&(Ve=[],E.set(Xe,Ve));const Ue=j.textures;if(Ve.length!==Ue.length||Ve[0]!==o.COLOR_ATTACHMENT0){for(let we=0,nt=Ue.length;we<nt;we++)Ve[we]=o.COLOR_ATTACHMENT0+we;Ve.length=Ue.length,Ge=!0}}else Ve[0]!==o.BACK&&(Ve[0]=o.BACK,Ge=!0);Ge&&o.drawBuffers(Ve)}function tt(j){return U!==j?(o.useProgram(j),U=j,!0):!1}const Jt={[gs]:o.FUNC_ADD,[Iy]:o.FUNC_SUBTRACT,[Hy]:o.FUNC_REVERSE_SUBTRACT};Jt[Vy]=o.MIN,Jt[Gy]=o.MAX;const _t={[ky]:o.ZERO,[Xy]:o.ONE,[Wy]:o.SRC_COLOR,[rp]:o.SRC_ALPHA,[Qy]:o.SRC_ALPHA_SATURATE,[Zy]:o.DST_COLOR,[Yy]:o.DST_ALPHA,[qy]:o.ONE_MINUS_SRC_COLOR,[sp]:o.ONE_MINUS_SRC_ALPHA,[Ky]:o.ONE_MINUS_DST_COLOR,[jy]:o.ONE_MINUS_DST_ALPHA,[Jy]:o.CONSTANT_COLOR,[$y]:o.ONE_MINUS_CONSTANT_COLOR,[eS]:o.CONSTANT_ALPHA,[tS]:o.ONE_MINUS_CONSTANT_ALPHA};function At(j,Xe,Ve,Ge,Ue,we,nt,Mt,it,$t){if(j===Ja){N===!0&&(ye(o.BLEND),N=!1);return}if(N===!1&&(Q(o.BLEND),N=!0),j!==By){if(j!==T||$t!==P){if((M!==gs||Y!==gs)&&(o.blendEquation(o.FUNC_ADD),M=gs,Y=gs),$t)switch(j){case Do:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case yg:o.blendFunc(o.ONE,o.ONE);break;case Sg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case bg:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:Cn("WebGLState: Invalid blending: ",j);break}else switch(j){case Do:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case yg:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case Sg:Cn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case bg:Cn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Cn("WebGLState: Invalid blending: ",j);break}X=null,I=null,ee=null,V=null,k.set(0,0,0),he=0,T=j,P=$t}return}Ue=Ue||Xe,we=we||Ve,nt=nt||Ge,(Xe!==M||Ue!==Y)&&(o.blendEquationSeparate(Jt[Xe],Jt[Ue]),M=Xe,Y=Ue),(Ve!==X||Ge!==I||we!==ee||nt!==V)&&(o.blendFuncSeparate(_t[Ve],_t[Ge],_t[we],_t[nt]),X=Ve,I=Ge,ee=we,V=nt),(Mt.equals(k)===!1||it!==he)&&(o.blendColor(Mt.r,Mt.g,Mt.b,it),k.copy(Mt),he=it),T=j,P=!1}function W(j,Xe){j.side===_a?ye(o.CULL_FACE):Q(o.CULL_FACE);let Ve=j.side===Mi;Xe&&(Ve=!Ve),gt(Ve),j.blending===Do&&j.transparent===!1?At(Ja):At(j.blending,j.blendEquation,j.blendSrc,j.blendDst,j.blendEquationAlpha,j.blendSrcAlpha,j.blendDstAlpha,j.blendColor,j.blendAlpha,j.premultipliedAlpha),p.setFunc(j.depthFunc),p.setTest(j.depthTest),p.setMask(j.depthWrite),f.setMask(j.colorWrite);const Ge=j.stencilWrite;m.setTest(Ge),Ge&&(m.setMask(j.stencilWriteMask),m.setFunc(j.stencilFunc,j.stencilRef,j.stencilFuncMask),m.setOp(j.stencilFail,j.stencilZFail,j.stencilZPass)),qe(j.polygonOffset,j.polygonOffsetFactor,j.polygonOffsetUnits),j.alphaToCoverage===!0?Q(o.SAMPLE_ALPHA_TO_COVERAGE):ye(o.SAMPLE_ALPHA_TO_COVERAGE)}function gt(j){O!==j&&(j?o.frontFace(o.CW):o.frontFace(o.CCW),O=j)}function Tt(j){j!==Py?(Q(o.CULL_FACE),j!==J&&(j===vg?o.cullFace(o.BACK):j===Fy?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):ye(o.CULL_FACE),J=j}function Vt(j){j!==se&&(z&&o.lineWidth(j),se=j)}function qe(j,Xe,Ve){j?(Q(o.POLYGON_OFFSET_FILL),(ue!==Xe||Me!==Ve)&&(o.polygonOffset(Xe,Ve),ue=Xe,Me=Ve)):ye(o.POLYGON_OFFSET_FILL)}function Lt(j){j?Q(o.SCISSOR_TEST):ye(o.SCISSOR_TEST)}function st(j){j===void 0&&(j=o.TEXTURE0+Se-1),Te!==j&&(o.activeTexture(j),Te=j)}function yt(j,Xe,Ve){Ve===void 0&&(Te===null?Ve=o.TEXTURE0+Se-1:Ve=Te);let Ge=Ce[Ve];Ge===void 0&&(Ge={type:void 0,texture:void 0},Ce[Ve]=Ge),(Ge.type!==j||Ge.texture!==Xe)&&(Te!==Ve&&(o.activeTexture(Ve),Te=Ve),o.bindTexture(j,Xe||de[j]),Ge.type=j,Ge.texture=Xe)}function B(){const j=Ce[Te];j!==void 0&&j.type!==void 0&&(o.bindTexture(j.type,null),j.type=void 0,j.texture=void 0)}function R(){try{o.compressedTexImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function oe(){try{o.compressedTexImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function Ae(){try{o.texSubImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function Le(){try{o.texSubImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function re(){try{o.compressedTexSubImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function Ze(){try{o.compressedTexSubImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function We(){try{o.texStorage2D(...arguments)}catch(j){j("WebGLState:",j)}}function dt(){try{o.texStorage3D(...arguments)}catch(j){j("WebGLState:",j)}}function He(){try{o.texImage2D(...arguments)}catch(j){j("WebGLState:",j)}}function Ne(){try{o.texImage3D(...arguments)}catch(j){j("WebGLState:",j)}}function Pe(j){De.equals(j)===!1&&(o.scissor(j.x,j.y,j.z,j.w),De.copy(j))}function ot(j){Fe.equals(j)===!1&&(o.viewport(j.x,j.y,j.z,j.w),Fe.copy(j))}function lt(j,Xe){let Ve=_.get(Xe);Ve===void 0&&(Ve=new WeakMap,_.set(Xe,Ve));let Ge=Ve.get(j);Ge===void 0&&(Ge=o.getUniformBlockIndex(Xe,j.name),Ve.set(j,Ge))}function Ye(j,Xe){const Ge=_.get(Xe).get(j);x.get(Xe)!==Ge&&(o.uniformBlockBinding(Xe,Ge,j.__bindingPointIndex),x.set(Xe,Ge))}function vt(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),p.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),S={},Te=null,Ce={},b={},E=new WeakMap,A=[],U=null,N=!1,T=null,M=null,X=null,I=null,Y=null,ee=null,V=null,k=new Kt(0,0,0),he=0,P=!1,O=null,J=null,se=null,ue=null,Me=null,De.set(0,0,o.canvas.width,o.canvas.height),Fe.set(0,0,o.canvas.width,o.canvas.height),f.reset(),p.reset(),m.reset()}return{buffers:{color:f,depth:p,stencil:m},enable:Q,disable:ye,bindFramebuffer:Ie,drawBuffers:ke,useProgram:tt,setBlending:At,setMaterial:W,setFlipSided:gt,setCullFace:Tt,setLineWidth:Vt,setPolygonOffset:qe,setScissorTest:Lt,activeTexture:st,bindTexture:yt,unbindTexture:B,compressedTexImage2D:R,compressedTexImage3D:oe,texImage2D:He,texImage3D:Ne,updateUBOMapping:lt,uniformBlockBinding:Ye,texStorage2D:We,texStorage3D:dt,texSubImage2D:Ae,texSubImage3D:Le,compressedTexSubImage2D:re,compressedTexSubImage3D:Ze,scissor:Pe,viewport:ot,reset:vt}}function V3(o,e,i,r,l,f,p){const m=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,x=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),_=new Ut,S=new WeakMap;let b;const E=new WeakMap;let A=!1;try{A=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function U(B,R){return A?new OffscreenCanvas(B,R):Yu("canvas")}function N(B,R,oe){let Ae=1;const Le=yt(B);if((Le.width>oe||Le.height>oe)&&(Ae=oe/Math.max(Le.width,Le.height)),Ae<1)if(typeof HTMLImageElement<"u"&&B instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&B instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&B instanceof ImageBitmap||typeof VideoFrame<"u"&&B instanceof VideoFrame){const re=Math.floor(Ae*Le.width),Ze=Math.floor(Ae*Le.height);b===void 0&&(b=U(re,Ze));const We=R?U(re,Ze):b;return We.width=re,We.height=Ze,We.getContext("2d").drawImage(B,0,0,re,Ze),Rt("WebGLRenderer: Texture has been resized from ("+Le.width+"x"+Le.height+") to ("+re+"x"+Ze+")."),We}else return"data"in B&&Rt("WebGLRenderer: Image in DataTexture is too big ("+Le.width+"x"+Le.height+")."),B;return B}function T(B){return B.generateMipmaps}function M(B){o.generateMipmap(B)}function X(B){return B.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:B.isWebGL3DRenderTarget?o.TEXTURE_3D:B.isWebGLArrayRenderTarget||B.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function I(B,R,oe,Ae,Le=!1){if(B!==null){if(o[B]!==void 0)return o[B];Rt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+B+"'")}let re=R;if(R===o.RED&&(oe===o.FLOAT&&(re=o.R32F),oe===o.HALF_FLOAT&&(re=o.R16F),oe===o.UNSIGNED_BYTE&&(re=o.R8)),R===o.RED_INTEGER&&(oe===o.UNSIGNED_BYTE&&(re=o.R8UI),oe===o.UNSIGNED_SHORT&&(re=o.R16UI),oe===o.UNSIGNED_INT&&(re=o.R32UI),oe===o.BYTE&&(re=o.R8I),oe===o.SHORT&&(re=o.R16I),oe===o.INT&&(re=o.R32I)),R===o.RG&&(oe===o.FLOAT&&(re=o.RG32F),oe===o.HALF_FLOAT&&(re=o.RG16F),oe===o.UNSIGNED_BYTE&&(re=o.RG8)),R===o.RG_INTEGER&&(oe===o.UNSIGNED_BYTE&&(re=o.RG8UI),oe===o.UNSIGNED_SHORT&&(re=o.RG16UI),oe===o.UNSIGNED_INT&&(re=o.RG32UI),oe===o.BYTE&&(re=o.RG8I),oe===o.SHORT&&(re=o.RG16I),oe===o.INT&&(re=o.RG32I)),R===o.RGB_INTEGER&&(oe===o.UNSIGNED_BYTE&&(re=o.RGB8UI),oe===o.UNSIGNED_SHORT&&(re=o.RGB16UI),oe===o.UNSIGNED_INT&&(re=o.RGB32UI),oe===o.BYTE&&(re=o.RGB8I),oe===o.SHORT&&(re=o.RGB16I),oe===o.INT&&(re=o.RGB32I)),R===o.RGBA_INTEGER&&(oe===o.UNSIGNED_BYTE&&(re=o.RGBA8UI),oe===o.UNSIGNED_SHORT&&(re=o.RGBA16UI),oe===o.UNSIGNED_INT&&(re=o.RGBA32UI),oe===o.BYTE&&(re=o.RGBA8I),oe===o.SHORT&&(re=o.RGBA16I),oe===o.INT&&(re=o.RGBA32I)),R===o.RGB&&(oe===o.UNSIGNED_INT_5_9_9_9_REV&&(re=o.RGB9_E5),oe===o.UNSIGNED_INT_10F_11F_11F_REV&&(re=o.R11F_G11F_B10F)),R===o.RGBA){const Ze=Le?Wu:an.getTransfer(Ae);oe===o.FLOAT&&(re=o.RGBA32F),oe===o.HALF_FLOAT&&(re=o.RGBA16F),oe===o.UNSIGNED_BYTE&&(re=Ze===pn?o.SRGB8_ALPHA8:o.RGBA8),oe===o.UNSIGNED_SHORT_4_4_4_4&&(re=o.RGBA4),oe===o.UNSIGNED_SHORT_5_5_5_1&&(re=o.RGB5_A1)}return(re===o.R16F||re===o.R32F||re===o.RG16F||re===o.RG32F||re===o.RGBA16F||re===o.RGBA32F)&&e.get("EXT_color_buffer_float"),re}function Y(B,R){let oe;return B?R===null||R===ys||R===Yl?oe=o.DEPTH24_STENCIL8:R===Qa?oe=o.DEPTH32F_STENCIL8:R===ql&&(oe=o.DEPTH24_STENCIL8,Rt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):R===null||R===ys||R===Yl?oe=o.DEPTH_COMPONENT24:R===Qa?oe=o.DEPTH_COMPONENT32F:R===ql&&(oe=o.DEPTH_COMPONENT16),oe}function ee(B,R){return T(B)===!0||B.isFramebufferTexture&&B.minFilter!==Li&&B.minFilter!==qi?Math.log2(Math.max(R.width,R.height))+1:B.mipmaps!==void 0&&B.mipmaps.length>0?B.mipmaps.length:B.isCompressedTexture&&Array.isArray(B.image)?R.mipmaps.length:1}function V(B){const R=B.target;R.removeEventListener("dispose",V),he(R),R.isVideoTexture&&S.delete(R)}function k(B){const R=B.target;R.removeEventListener("dispose",k),O(R)}function he(B){const R=r.get(B);if(R.__webglInit===void 0)return;const oe=B.source,Ae=E.get(oe);if(Ae){const Le=Ae[R.__cacheKey];Le.usedTimes--,Le.usedTimes===0&&P(B),Object.keys(Ae).length===0&&E.delete(oe)}r.remove(B)}function P(B){const R=r.get(B);o.deleteTexture(R.__webglTexture);const oe=B.source,Ae=E.get(oe);delete Ae[R.__cacheKey],p.memory.textures--}function O(B){const R=r.get(B);if(B.depthTexture&&(B.depthTexture.dispose(),r.remove(B.depthTexture)),B.isWebGLCubeRenderTarget)for(let Ae=0;Ae<6;Ae++){if(Array.isArray(R.__webglFramebuffer[Ae]))for(let Le=0;Le<R.__webglFramebuffer[Ae].length;Le++)o.deleteFramebuffer(R.__webglFramebuffer[Ae][Le]);else o.deleteFramebuffer(R.__webglFramebuffer[Ae]);R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer[Ae])}else{if(Array.isArray(R.__webglFramebuffer))for(let Ae=0;Ae<R.__webglFramebuffer.length;Ae++)o.deleteFramebuffer(R.__webglFramebuffer[Ae]);else o.deleteFramebuffer(R.__webglFramebuffer);if(R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer),R.__webglMultisampledFramebuffer&&o.deleteFramebuffer(R.__webglMultisampledFramebuffer),R.__webglColorRenderbuffer)for(let Ae=0;Ae<R.__webglColorRenderbuffer.length;Ae++)R.__webglColorRenderbuffer[Ae]&&o.deleteRenderbuffer(R.__webglColorRenderbuffer[Ae]);R.__webglDepthRenderbuffer&&o.deleteRenderbuffer(R.__webglDepthRenderbuffer)}const oe=B.textures;for(let Ae=0,Le=oe.length;Ae<Le;Ae++){const re=r.get(oe[Ae]);re.__webglTexture&&(o.deleteTexture(re.__webglTexture),p.memory.textures--),r.remove(oe[Ae])}r.remove(B)}let J=0;function se(){J=0}function ue(){const B=J;return B>=l.maxTextures&&Rt("WebGLTextures: Trying to use "+B+" texture units while this GPU supports only "+l.maxTextures),J+=1,B}function Me(B){const R=[];return R.push(B.wrapS),R.push(B.wrapT),R.push(B.wrapR||0),R.push(B.magFilter),R.push(B.minFilter),R.push(B.anisotropy),R.push(B.internalFormat),R.push(B.format),R.push(B.type),R.push(B.generateMipmaps),R.push(B.premultiplyAlpha),R.push(B.flipY),R.push(B.unpackAlignment),R.push(B.colorSpace),R.join()}function Se(B,R){const oe=r.get(B);if(B.isVideoTexture&&Lt(B),B.isRenderTargetTexture===!1&&B.isExternalTexture!==!0&&B.version>0&&oe.__version!==B.version){const Ae=B.image;if(Ae===null)Rt("WebGLRenderer: Texture marked for update but no image data found.");else if(Ae.complete===!1)Rt("WebGLRenderer: Texture marked for update but image is incomplete");else{de(oe,B,R);return}}else B.isExternalTexture&&(oe.__webglTexture=B.sourceTexture?B.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,oe.__webglTexture,o.TEXTURE0+R)}function z(B,R){const oe=r.get(B);if(B.isRenderTargetTexture===!1&&B.version>0&&oe.__version!==B.version){de(oe,B,R);return}else B.isExternalTexture&&(oe.__webglTexture=B.sourceTexture?B.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,oe.__webglTexture,o.TEXTURE0+R)}function $(B,R){const oe=r.get(B);if(B.isRenderTargetTexture===!1&&B.version>0&&oe.__version!==B.version){de(oe,B,R);return}i.bindTexture(o.TEXTURE_3D,oe.__webglTexture,o.TEXTURE0+R)}function ie(B,R){const oe=r.get(B);if(B.version>0&&oe.__version!==B.version){Q(oe,B,R);return}i.bindTexture(o.TEXTURE_CUBE_MAP,oe.__webglTexture,o.TEXTURE0+R)}const Te={[_p]:o.REPEAT,[Ka]:o.CLAMP_TO_EDGE,[gp]:o.MIRRORED_REPEAT},Ce={[Li]:o.NEAREST,[fS]:o.NEAREST_MIPMAP_NEAREST,[_u]:o.NEAREST_MIPMAP_LINEAR,[qi]:o.LINEAR,[Ed]:o.LINEAR_MIPMAP_NEAREST,[vs]:o.LINEAR_MIPMAP_LINEAR},H={[mS]:o.NEVER,[SS]:o.ALWAYS,[_S]:o.LESS,[Ix]:o.LEQUAL,[gS]:o.EQUAL,[yS]:o.GEQUAL,[xS]:o.GREATER,[vS]:o.NOTEQUAL};function me(B,R){if(R.type===Qa&&e.has("OES_texture_float_linear")===!1&&(R.magFilter===qi||R.magFilter===Ed||R.magFilter===_u||R.magFilter===vs||R.minFilter===qi||R.minFilter===Ed||R.minFilter===_u||R.minFilter===vs)&&Rt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(B,o.TEXTURE_WRAP_S,Te[R.wrapS]),o.texParameteri(B,o.TEXTURE_WRAP_T,Te[R.wrapT]),(B===o.TEXTURE_3D||B===o.TEXTURE_2D_ARRAY)&&o.texParameteri(B,o.TEXTURE_WRAP_R,Te[R.wrapR]),o.texParameteri(B,o.TEXTURE_MAG_FILTER,Ce[R.magFilter]),o.texParameteri(B,o.TEXTURE_MIN_FILTER,Ce[R.minFilter]),R.compareFunction&&(o.texParameteri(B,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(B,o.TEXTURE_COMPARE_FUNC,H[R.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(R.magFilter===Li||R.minFilter!==_u&&R.minFilter!==vs||R.type===Qa&&e.has("OES_texture_float_linear")===!1)return;if(R.anisotropy>1||r.get(R).__currentAnisotropy){const oe=e.get("EXT_texture_filter_anisotropic");o.texParameterf(B,oe.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(R.anisotropy,l.getMaxAnisotropy())),r.get(R).__currentAnisotropy=R.anisotropy}}}function De(B,R){let oe=!1;B.__webglInit===void 0&&(B.__webglInit=!0,R.addEventListener("dispose",V));const Ae=R.source;let Le=E.get(Ae);Le===void 0&&(Le={},E.set(Ae,Le));const re=Me(R);if(re!==B.__cacheKey){Le[re]===void 0&&(Le[re]={texture:o.createTexture(),usedTimes:0},p.memory.textures++,oe=!0),Le[re].usedTimes++;const Ze=Le[B.__cacheKey];Ze!==void 0&&(Le[B.__cacheKey].usedTimes--,Ze.usedTimes===0&&P(R)),B.__cacheKey=re,B.__webglTexture=Le[re].texture}return oe}function Fe(B,R,oe){return Math.floor(Math.floor(B/oe)/R)}function $e(B,R,oe,Ae){const re=B.updateRanges;if(re.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,R.width,R.height,oe,Ae,R.data);else{re.sort((Ne,Pe)=>Ne.start-Pe.start);let Ze=0;for(let Ne=1;Ne<re.length;Ne++){const Pe=re[Ze],ot=re[Ne],lt=Pe.start+Pe.count,Ye=Fe(ot.start,R.width,4),vt=Fe(Pe.start,R.width,4);ot.start<=lt+1&&Ye===vt&&Fe(ot.start+ot.count-1,R.width,4)===Ye?Pe.count=Math.max(Pe.count,ot.start+ot.count-Pe.start):(++Ze,re[Ze]=ot)}re.length=Ze+1;const We=o.getParameter(o.UNPACK_ROW_LENGTH),dt=o.getParameter(o.UNPACK_SKIP_PIXELS),He=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,R.width);for(let Ne=0,Pe=re.length;Ne<Pe;Ne++){const ot=re[Ne],lt=Math.floor(ot.start/4),Ye=Math.ceil(ot.count/4),vt=lt%R.width,j=Math.floor(lt/R.width),Xe=Ye,Ve=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,vt),o.pixelStorei(o.UNPACK_SKIP_ROWS,j),i.texSubImage2D(o.TEXTURE_2D,0,vt,j,Xe,Ve,oe,Ae,R.data)}B.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,We),o.pixelStorei(o.UNPACK_SKIP_PIXELS,dt),o.pixelStorei(o.UNPACK_SKIP_ROWS,He)}}function de(B,R,oe){let Ae=o.TEXTURE_2D;(R.isDataArrayTexture||R.isCompressedArrayTexture)&&(Ae=o.TEXTURE_2D_ARRAY),R.isData3DTexture&&(Ae=o.TEXTURE_3D);const Le=De(B,R),re=R.source;i.bindTexture(Ae,B.__webglTexture,o.TEXTURE0+oe);const Ze=r.get(re);if(re.version!==Ze.__version||Le===!0){i.activeTexture(o.TEXTURE0+oe);const We=an.getPrimaries(an.workingColorSpace),dt=R.colorSpace===zr?null:an.getPrimaries(R.colorSpace),He=R.colorSpace===zr||We===dt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,He);let Ne=N(R.image,!1,l.maxTextureSize);Ne=st(R,Ne);const Pe=f.convert(R.format,R.colorSpace),ot=f.convert(R.type);let lt=I(R.internalFormat,Pe,ot,R.colorSpace,R.isVideoTexture);me(Ae,R);let Ye;const vt=R.mipmaps,j=R.isVideoTexture!==!0,Xe=Ze.__version===void 0||Le===!0,Ve=re.dataReady,Ge=ee(R,Ne);if(R.isDepthTexture)lt=Y(R.format===Zl,R.type),Xe&&(j?i.texStorage2D(o.TEXTURE_2D,1,lt,Ne.width,Ne.height):i.texImage2D(o.TEXTURE_2D,0,lt,Ne.width,Ne.height,0,Pe,ot,null));else if(R.isDataTexture)if(vt.length>0){j&&Xe&&i.texStorage2D(o.TEXTURE_2D,Ge,lt,vt[0].width,vt[0].height);for(let Ue=0,we=vt.length;Ue<we;Ue++)Ye=vt[Ue],j?Ve&&i.texSubImage2D(o.TEXTURE_2D,Ue,0,0,Ye.width,Ye.height,Pe,ot,Ye.data):i.texImage2D(o.TEXTURE_2D,Ue,lt,Ye.width,Ye.height,0,Pe,ot,Ye.data);R.generateMipmaps=!1}else j?(Xe&&i.texStorage2D(o.TEXTURE_2D,Ge,lt,Ne.width,Ne.height),Ve&&$e(R,Ne,Pe,ot)):i.texImage2D(o.TEXTURE_2D,0,lt,Ne.width,Ne.height,0,Pe,ot,Ne.data);else if(R.isCompressedTexture)if(R.isCompressedArrayTexture){j&&Xe&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ge,lt,vt[0].width,vt[0].height,Ne.depth);for(let Ue=0,we=vt.length;Ue<we;Ue++)if(Ye=vt[Ue],R.format!==ra)if(Pe!==null)if(j){if(Ve)if(R.layerUpdates.size>0){const nt=ex(Ye.width,Ye.height,R.format,R.type);for(const Mt of R.layerUpdates){const it=Ye.data.subarray(Mt*nt/Ye.data.BYTES_PER_ELEMENT,(Mt+1)*nt/Ye.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Ue,0,0,Mt,Ye.width,Ye.height,1,Pe,it)}R.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Ue,0,0,0,Ye.width,Ye.height,Ne.depth,Pe,Ye.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Ue,lt,Ye.width,Ye.height,Ne.depth,0,Ye.data,0,0);else Rt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else j?Ve&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,Ue,0,0,0,Ye.width,Ye.height,Ne.depth,Pe,ot,Ye.data):i.texImage3D(o.TEXTURE_2D_ARRAY,Ue,lt,Ye.width,Ye.height,Ne.depth,0,Pe,ot,Ye.data)}else{j&&Xe&&i.texStorage2D(o.TEXTURE_2D,Ge,lt,vt[0].width,vt[0].height);for(let Ue=0,we=vt.length;Ue<we;Ue++)Ye=vt[Ue],R.format!==ra?Pe!==null?j?Ve&&i.compressedTexSubImage2D(o.TEXTURE_2D,Ue,0,0,Ye.width,Ye.height,Pe,Ye.data):i.compressedTexImage2D(o.TEXTURE_2D,Ue,lt,Ye.width,Ye.height,0,Ye.data):Rt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):j?Ve&&i.texSubImage2D(o.TEXTURE_2D,Ue,0,0,Ye.width,Ye.height,Pe,ot,Ye.data):i.texImage2D(o.TEXTURE_2D,Ue,lt,Ye.width,Ye.height,0,Pe,ot,Ye.data)}else if(R.isDataArrayTexture)if(j){if(Xe&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ge,lt,Ne.width,Ne.height,Ne.depth),Ve)if(R.layerUpdates.size>0){const Ue=ex(Ne.width,Ne.height,R.format,R.type);for(const we of R.layerUpdates){const nt=Ne.data.subarray(we*Ue/Ne.data.BYTES_PER_ELEMENT,(we+1)*Ue/Ne.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,we,Ne.width,Ne.height,1,Pe,ot,nt)}R.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Ne.width,Ne.height,Ne.depth,Pe,ot,Ne.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,lt,Ne.width,Ne.height,Ne.depth,0,Pe,ot,Ne.data);else if(R.isData3DTexture)j?(Xe&&i.texStorage3D(o.TEXTURE_3D,Ge,lt,Ne.width,Ne.height,Ne.depth),Ve&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Ne.width,Ne.height,Ne.depth,Pe,ot,Ne.data)):i.texImage3D(o.TEXTURE_3D,0,lt,Ne.width,Ne.height,Ne.depth,0,Pe,ot,Ne.data);else if(R.isFramebufferTexture){if(Xe)if(j)i.texStorage2D(o.TEXTURE_2D,Ge,lt,Ne.width,Ne.height);else{let Ue=Ne.width,we=Ne.height;for(let nt=0;nt<Ge;nt++)i.texImage2D(o.TEXTURE_2D,nt,lt,Ue,we,0,Pe,ot,null),Ue>>=1,we>>=1}}else if(vt.length>0){if(j&&Xe){const Ue=yt(vt[0]);i.texStorage2D(o.TEXTURE_2D,Ge,lt,Ue.width,Ue.height)}for(let Ue=0,we=vt.length;Ue<we;Ue++)Ye=vt[Ue],j?Ve&&i.texSubImage2D(o.TEXTURE_2D,Ue,0,0,Pe,ot,Ye):i.texImage2D(o.TEXTURE_2D,Ue,lt,Pe,ot,Ye);R.generateMipmaps=!1}else if(j){if(Xe){const Ue=yt(Ne);i.texStorage2D(o.TEXTURE_2D,Ge,lt,Ue.width,Ue.height)}Ve&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Pe,ot,Ne)}else i.texImage2D(o.TEXTURE_2D,0,lt,Pe,ot,Ne);T(R)&&M(Ae),Ze.__version=re.version,R.onUpdate&&R.onUpdate(R)}B.__version=R.version}function Q(B,R,oe){if(R.image.length!==6)return;const Ae=De(B,R),Le=R.source;i.bindTexture(o.TEXTURE_CUBE_MAP,B.__webglTexture,o.TEXTURE0+oe);const re=r.get(Le);if(Le.version!==re.__version||Ae===!0){i.activeTexture(o.TEXTURE0+oe);const Ze=an.getPrimaries(an.workingColorSpace),We=R.colorSpace===zr?null:an.getPrimaries(R.colorSpace),dt=R.colorSpace===zr||Ze===We?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);const He=R.isCompressedTexture||R.image[0].isCompressedTexture,Ne=R.image[0]&&R.image[0].isDataTexture,Pe=[];for(let we=0;we<6;we++)!He&&!Ne?Pe[we]=N(R.image[we],!0,l.maxCubemapSize):Pe[we]=Ne?R.image[we].image:R.image[we],Pe[we]=st(R,Pe[we]);const ot=Pe[0],lt=f.convert(R.format,R.colorSpace),Ye=f.convert(R.type),vt=I(R.internalFormat,lt,Ye,R.colorSpace),j=R.isVideoTexture!==!0,Xe=re.__version===void 0||Ae===!0,Ve=Le.dataReady;let Ge=ee(R,ot);me(o.TEXTURE_CUBE_MAP,R);let Ue;if(He){j&&Xe&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Ge,vt,ot.width,ot.height);for(let we=0;we<6;we++){Ue=Pe[we].mipmaps;for(let nt=0;nt<Ue.length;nt++){const Mt=Ue[nt];R.format!==ra?lt!==null?j?Ve&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt,0,0,Mt.width,Mt.height,lt,Mt.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt,vt,Mt.width,Mt.height,0,Mt.data):Rt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):j?Ve&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt,0,0,Mt.width,Mt.height,lt,Ye,Mt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt,vt,Mt.width,Mt.height,0,lt,Ye,Mt.data)}}}else{if(Ue=R.mipmaps,j&&Xe){Ue.length>0&&Ge++;const we=yt(Pe[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Ge,vt,we.width,we.height)}for(let we=0;we<6;we++)if(Ne){j?Ve&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,0,0,Pe[we].width,Pe[we].height,lt,Ye,Pe[we].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,vt,Pe[we].width,Pe[we].height,0,lt,Ye,Pe[we].data);for(let nt=0;nt<Ue.length;nt++){const it=Ue[nt].image[we].image;j?Ve&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt+1,0,0,it.width,it.height,lt,Ye,it.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt+1,vt,it.width,it.height,0,lt,Ye,it.data)}}else{j?Ve&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,0,0,lt,Ye,Pe[we]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,vt,lt,Ye,Pe[we]);for(let nt=0;nt<Ue.length;nt++){const Mt=Ue[nt];j?Ve&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt+1,0,0,lt,Ye,Mt.image[we]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+we,nt+1,vt,lt,Ye,Mt.image[we])}}}T(R)&&M(o.TEXTURE_CUBE_MAP),re.__version=Le.version,R.onUpdate&&R.onUpdate(R)}B.__version=R.version}function ye(B,R,oe,Ae,Le,re){const Ze=f.convert(oe.format,oe.colorSpace),We=f.convert(oe.type),dt=I(oe.internalFormat,Ze,We,oe.colorSpace),He=r.get(R),Ne=r.get(oe);if(Ne.__renderTarget=R,!He.__hasExternalTextures){const Pe=Math.max(1,R.width>>re),ot=Math.max(1,R.height>>re);Le===o.TEXTURE_3D||Le===o.TEXTURE_2D_ARRAY?i.texImage3D(Le,re,dt,Pe,ot,R.depth,0,Ze,We,null):i.texImage2D(Le,re,dt,Pe,ot,0,Ze,We,null)}i.bindFramebuffer(o.FRAMEBUFFER,B),qe(R)?m.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Ae,Le,Ne.__webglTexture,0,Vt(R)):(Le===o.TEXTURE_2D||Le>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&Le<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,Ae,Le,Ne.__webglTexture,re),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Ie(B,R,oe){if(o.bindRenderbuffer(o.RENDERBUFFER,B),R.depthBuffer){const Ae=R.depthTexture,Le=Ae&&Ae.isDepthTexture?Ae.type:null,re=Y(R.stencilBuffer,Le),Ze=R.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,We=Vt(R);qe(R)?m.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,We,re,R.width,R.height):oe?o.renderbufferStorageMultisample(o.RENDERBUFFER,We,re,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,re,R.width,R.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Ze,o.RENDERBUFFER,B)}else{const Ae=R.textures;for(let Le=0;Le<Ae.length;Le++){const re=Ae[Le],Ze=f.convert(re.format,re.colorSpace),We=f.convert(re.type),dt=I(re.internalFormat,Ze,We,re.colorSpace),He=Vt(R);oe&&qe(R)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,He,dt,R.width,R.height):qe(R)?m.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,He,dt,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,dt,R.width,R.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function ke(B,R){if(R&&R.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,B),!(R.depthTexture&&R.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Ae=r.get(R.depthTexture);Ae.__renderTarget=R,(!Ae.__webglTexture||R.depthTexture.image.width!==R.width||R.depthTexture.image.height!==R.height)&&(R.depthTexture.image.width=R.width,R.depthTexture.image.height=R.height,R.depthTexture.needsUpdate=!0),Se(R.depthTexture,0);const Le=Ae.__webglTexture,re=Vt(R);if(R.depthTexture.format===jl)qe(R)?m.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Le,0,re):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Le,0);else if(R.depthTexture.format===Zl)qe(R)?m.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Le,0,re):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Le,0);else throw new Error("Unknown depthTexture format")}function tt(B){const R=r.get(B),oe=B.isWebGLCubeRenderTarget===!0;if(R.__boundDepthTexture!==B.depthTexture){const Ae=B.depthTexture;if(R.__depthDisposeCallback&&R.__depthDisposeCallback(),Ae){const Le=()=>{delete R.__boundDepthTexture,delete R.__depthDisposeCallback,Ae.removeEventListener("dispose",Le)};Ae.addEventListener("dispose",Le),R.__depthDisposeCallback=Le}R.__boundDepthTexture=Ae}if(B.depthTexture&&!R.__autoAllocateDepthBuffer){if(oe)throw new Error("target.depthTexture not supported in Cube render targets");const Ae=B.texture.mipmaps;Ae&&Ae.length>0?ke(R.__webglFramebuffer[0],B):ke(R.__webglFramebuffer,B)}else if(oe){R.__webglDepthbuffer=[];for(let Ae=0;Ae<6;Ae++)if(i.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[Ae]),R.__webglDepthbuffer[Ae]===void 0)R.__webglDepthbuffer[Ae]=o.createRenderbuffer(),Ie(R.__webglDepthbuffer[Ae],B,!1);else{const Le=B.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,re=R.__webglDepthbuffer[Ae];o.bindRenderbuffer(o.RENDERBUFFER,re),o.framebufferRenderbuffer(o.FRAMEBUFFER,Le,o.RENDERBUFFER,re)}}else{const Ae=B.texture.mipmaps;if(Ae&&Ae.length>0?i.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer),R.__webglDepthbuffer===void 0)R.__webglDepthbuffer=o.createRenderbuffer(),Ie(R.__webglDepthbuffer,B,!1);else{const Le=B.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,re=R.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,re),o.framebufferRenderbuffer(o.FRAMEBUFFER,Le,o.RENDERBUFFER,re)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function Jt(B,R,oe){const Ae=r.get(B);R!==void 0&&ye(Ae.__webglFramebuffer,B,B.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),oe!==void 0&&tt(B)}function _t(B){const R=B.texture,oe=r.get(B),Ae=r.get(R);B.addEventListener("dispose",k);const Le=B.textures,re=B.isWebGLCubeRenderTarget===!0,Ze=Le.length>1;if(Ze||(Ae.__webglTexture===void 0&&(Ae.__webglTexture=o.createTexture()),Ae.__version=R.version,p.memory.textures++),re){oe.__webglFramebuffer=[];for(let We=0;We<6;We++)if(R.mipmaps&&R.mipmaps.length>0){oe.__webglFramebuffer[We]=[];for(let dt=0;dt<R.mipmaps.length;dt++)oe.__webglFramebuffer[We][dt]=o.createFramebuffer()}else oe.__webglFramebuffer[We]=o.createFramebuffer()}else{if(R.mipmaps&&R.mipmaps.length>0){oe.__webglFramebuffer=[];for(let We=0;We<R.mipmaps.length;We++)oe.__webglFramebuffer[We]=o.createFramebuffer()}else oe.__webglFramebuffer=o.createFramebuffer();if(Ze)for(let We=0,dt=Le.length;We<dt;We++){const He=r.get(Le[We]);He.__webglTexture===void 0&&(He.__webglTexture=o.createTexture(),p.memory.textures++)}if(B.samples>0&&qe(B)===!1){oe.__webglMultisampledFramebuffer=o.createFramebuffer(),oe.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,oe.__webglMultisampledFramebuffer);for(let We=0;We<Le.length;We++){const dt=Le[We];oe.__webglColorRenderbuffer[We]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,oe.__webglColorRenderbuffer[We]);const He=f.convert(dt.format,dt.colorSpace),Ne=f.convert(dt.type),Pe=I(dt.internalFormat,He,Ne,dt.colorSpace,B.isXRRenderTarget===!0),ot=Vt(B);o.renderbufferStorageMultisample(o.RENDERBUFFER,ot,Pe,B.width,B.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+We,o.RENDERBUFFER,oe.__webglColorRenderbuffer[We])}o.bindRenderbuffer(o.RENDERBUFFER,null),B.depthBuffer&&(oe.__webglDepthRenderbuffer=o.createRenderbuffer(),Ie(oe.__webglDepthRenderbuffer,B,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(re){i.bindTexture(o.TEXTURE_CUBE_MAP,Ae.__webglTexture),me(o.TEXTURE_CUBE_MAP,R);for(let We=0;We<6;We++)if(R.mipmaps&&R.mipmaps.length>0)for(let dt=0;dt<R.mipmaps.length;dt++)ye(oe.__webglFramebuffer[We][dt],B,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+We,dt);else ye(oe.__webglFramebuffer[We],B,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+We,0);T(R)&&M(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Ze){for(let We=0,dt=Le.length;We<dt;We++){const He=Le[We],Ne=r.get(He);let Pe=o.TEXTURE_2D;(B.isWebGL3DRenderTarget||B.isWebGLArrayRenderTarget)&&(Pe=B.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Pe,Ne.__webglTexture),me(Pe,He),ye(oe.__webglFramebuffer,B,He,o.COLOR_ATTACHMENT0+We,Pe,0),T(He)&&M(Pe)}i.unbindTexture()}else{let We=o.TEXTURE_2D;if((B.isWebGL3DRenderTarget||B.isWebGLArrayRenderTarget)&&(We=B.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(We,Ae.__webglTexture),me(We,R),R.mipmaps&&R.mipmaps.length>0)for(let dt=0;dt<R.mipmaps.length;dt++)ye(oe.__webglFramebuffer[dt],B,R,o.COLOR_ATTACHMENT0,We,dt);else ye(oe.__webglFramebuffer,B,R,o.COLOR_ATTACHMENT0,We,0);T(R)&&M(We),i.unbindTexture()}B.depthBuffer&&tt(B)}function At(B){const R=B.textures;for(let oe=0,Ae=R.length;oe<Ae;oe++){const Le=R[oe];if(T(Le)){const re=X(B),Ze=r.get(Le).__webglTexture;i.bindTexture(re,Ze),M(re),i.unbindTexture()}}}const W=[],gt=[];function Tt(B){if(B.samples>0){if(qe(B)===!1){const R=B.textures,oe=B.width,Ae=B.height;let Le=o.COLOR_BUFFER_BIT;const re=B.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Ze=r.get(B),We=R.length>1;if(We)for(let He=0;He<R.length;He++)i.bindFramebuffer(o.FRAMEBUFFER,Ze.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+He,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Ze.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+He,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Ze.__webglMultisampledFramebuffer);const dt=B.texture.mipmaps;dt&&dt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Ze.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Ze.__webglFramebuffer);for(let He=0;He<R.length;He++){if(B.resolveDepthBuffer&&(B.depthBuffer&&(Le|=o.DEPTH_BUFFER_BIT),B.stencilBuffer&&B.resolveStencilBuffer&&(Le|=o.STENCIL_BUFFER_BIT)),We){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Ze.__webglColorRenderbuffer[He]);const Ne=r.get(R[He]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Ne,0)}o.blitFramebuffer(0,0,oe,Ae,0,0,oe,Ae,Le,o.NEAREST),x===!0&&(W.length=0,gt.length=0,W.push(o.COLOR_ATTACHMENT0+He),B.depthBuffer&&B.resolveDepthBuffer===!1&&(W.push(re),gt.push(re),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,gt)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,W))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),We)for(let He=0;He<R.length;He++){i.bindFramebuffer(o.FRAMEBUFFER,Ze.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+He,o.RENDERBUFFER,Ze.__webglColorRenderbuffer[He]);const Ne=r.get(R[He]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Ze.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+He,o.TEXTURE_2D,Ne,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Ze.__webglMultisampledFramebuffer)}else if(B.depthBuffer&&B.resolveDepthBuffer===!1&&x){const R=B.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[R])}}}function Vt(B){return Math.min(l.maxSamples,B.samples)}function qe(B){const R=r.get(B);return B.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&R.__useRenderToTexture!==!1}function Lt(B){const R=p.render.frame;S.get(B)!==R&&(S.set(B,R),B.update())}function st(B,R){const oe=B.colorSpace,Ae=B.format,Le=B.type;return B.isCompressedTexture===!0||B.isVideoTexture===!0||oe!==Po&&oe!==zr&&(an.getTransfer(oe)===pn?(Ae!==ra||Le!==va)&&Rt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Cn("WebGLTextures: Unsupported texture color space:",oe)),R}function yt(B){return typeof HTMLImageElement<"u"&&B instanceof HTMLImageElement?(_.width=B.naturalWidth||B.width,_.height=B.naturalHeight||B.height):typeof VideoFrame<"u"&&B instanceof VideoFrame?(_.width=B.displayWidth,_.height=B.displayHeight):(_.width=B.width,_.height=B.height),_}this.allocateTextureUnit=ue,this.resetTextureUnits=se,this.setTexture2D=Se,this.setTexture2DArray=z,this.setTexture3D=$,this.setTextureCube=ie,this.rebindTextures=Jt,this.setupRenderTarget=_t,this.updateRenderTargetMipmap=At,this.updateMultisampleRenderTarget=Tt,this.setupDepthRenderbuffer=tt,this.setupFrameBufferTexture=ye,this.useMultisampledRTT=qe}function G3(o,e){function i(r,l=zr){let f;const p=an.getTransfer(l);if(r===va)return o.UNSIGNED_BYTE;if(r===Jp)return o.UNSIGNED_SHORT_4_4_4_4;if(r===$p)return o.UNSIGNED_SHORT_5_5_5_1;if(r===Nx)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===Ox)return o.UNSIGNED_INT_10F_11F_11F_REV;if(r===Ux)return o.BYTE;if(r===Lx)return o.SHORT;if(r===ql)return o.UNSIGNED_SHORT;if(r===Qp)return o.INT;if(r===ys)return o.UNSIGNED_INT;if(r===Qa)return o.FLOAT;if(r===zo)return o.HALF_FLOAT;if(r===Px)return o.ALPHA;if(r===Fx)return o.RGB;if(r===ra)return o.RGBA;if(r===jl)return o.DEPTH_COMPONENT;if(r===Zl)return o.DEPTH_STENCIL;if(r===zx)return o.RED;if(r===em)return o.RED_INTEGER;if(r===tm)return o.RG;if(r===nm)return o.RG_INTEGER;if(r===im)return o.RGBA_INTEGER;if(r===Iu||r===Hu||r===Vu||r===Gu)if(p===pn)if(f=e.get("WEBGL_compressed_texture_s3tc_srgb"),f!==null){if(r===Iu)return f.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Hu)return f.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Vu)return f.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Gu)return f.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(f=e.get("WEBGL_compressed_texture_s3tc"),f!==null){if(r===Iu)return f.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Hu)return f.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Vu)return f.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Gu)return f.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===xp||r===vp||r===yp||r===Sp)if(f=e.get("WEBGL_compressed_texture_pvrtc"),f!==null){if(r===xp)return f.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===vp)return f.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===yp)return f.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Sp)return f.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===bp||r===Mp||r===Ep)if(f=e.get("WEBGL_compressed_texture_etc"),f!==null){if(r===bp||r===Mp)return p===pn?f.COMPRESSED_SRGB8_ETC2:f.COMPRESSED_RGB8_ETC2;if(r===Ep)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:f.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Tp||r===Ap||r===wp||r===Rp||r===Cp||r===Dp||r===Up||r===Lp||r===Np||r===Op||r===Pp||r===Fp||r===zp||r===Bp)if(f=e.get("WEBGL_compressed_texture_astc"),f!==null){if(r===Tp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:f.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Ap)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:f.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===wp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:f.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Rp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:f.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Cp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:f.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Dp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:f.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Up)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:f.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Lp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:f.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Np)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:f.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Op)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:f.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Pp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:f.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Fp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:f.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===zp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:f.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Bp)return p===pn?f.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:f.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Ip||r===Hp||r===Vp)if(f=e.get("EXT_texture_compression_bptc"),f!==null){if(r===Ip)return p===pn?f.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:f.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Hp)return f.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Vp)return f.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Gp||r===kp||r===Xp||r===Wp)if(f=e.get("EXT_texture_compression_rgtc"),f!==null){if(r===Gp)return f.COMPRESSED_RED_RGTC1_EXT;if(r===kp)return f.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Xp)return f.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Wp)return f.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Yl?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const k3=`
void main() {
